...
public class JsonAdaptedPersonTest {
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(INVALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_RACE,
                        VALID_ADDRESS, VALID_SCHOOL, VALID_MAJOR, VALID_PASTJOBS, VALID_TAGS);
    ...
    public void toModelType_invalidAddress_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_RACE,
                        INVALID_ADDRESS, VALID_SCHOOL, VALID_MAJOR, VALID_PASTJOBS, VALID_TAGS);
    ...
    public void toModelType_nullAddress_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_RACE,
                        null, VALID_SCHOOL, VALID_MAJOR, VALID_PASTJOBS, VALID_TAGS);
    ...
    public void toModelType_invalidSchool_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_RACE,
                        VALID_ADDRESS, INVALID_SCHOOL, VALID_MAJOR, VALID_PASTJOBS, VALID_TAGS);
    ...
    public void toModelType_nullSchool_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_RACE,
                        VALID_ADDRESS, null, VALID_MAJOR, VALID_PASTJOBS, VALID_TAGS);
    ...
    public void toModelType_invalidMajor_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL,
                VALID_RACE, VALID_ADDRESS, VALID_SCHOOL, INVALID_MAJOR, VALID_PASTJOBS, VALID_TAGS);
    ...
    public void toModelType_nullMajor_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL,
                VALID_RACE, VALID_ADDRESS, VALID_SCHOOL, null, VALID_PASTJOBS, VALID_TAGS);
    ...
    public void toModelType_invalidPastJobs_throwsIllegalValueException() {
        ...
        JsonAdaptedPerson person =
            new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL,
                    VALID_RACE, VALID_ADDRESS, VALID_SCHOOL, VALID_MAJOR, invalidPastJobs, VALID_TAGS);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL,
                        VALID_RACE, VALID_ADDRESS, VALID_SCHOOL, VALID_MAJOR, VALID_PASTJOBS, invalidTags);
        Assert.assertThrows(IllegalValueException.class, person::toModelType);
    }
