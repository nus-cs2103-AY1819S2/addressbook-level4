...
The _Sequence Diagram_ below shows how the components interact with each other for the scenarios where the user issues the command `import C:\Users\XXX\Desktop\Pictures` and `rotate 90`.
