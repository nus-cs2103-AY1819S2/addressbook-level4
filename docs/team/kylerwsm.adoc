...
* *Major enhancement*: greatly enhanced and functionalized the *person* class into a *dental patient* class
** What it does: This new data structure allows our users to store personal information of patients, their next-of-kin information, their dental records, and their current teeth layout.
** Justification: This data structure is the foundation of our product, as TeethHub is an application which primarily manages dental patients and their dental data for our dentist users.
...
include::../UserGuide.adoc[tag=patient_management_kyler]

include::../UserGuide.adoc[tag=attributes_kyler]
