...
You can add a PDF file to the app +
...
You can view a list of all PDF files in the app. +
Format: `list`

=== Opening a file : `open`

You can open an existing file at a specified index in the app with default PDF reader. +
Format: `open INDEX`
...
You can edit the name or tags of a file at the specified index of the list. +
...
You can deletes the file with specified index of the list from the app. +
Format: `delete INDEX`
...
You can move the file at the specified index of the list into another directory. +
...
You may exits the program with the exit command. +
Format: `exit`

=== Assigning and deleting tags to a file : `tag` `[Coming in v1.3]`

Assigning and/or deleting tags to an existing file in the list of the app. Use `-` to
