...
Below can be found the state diagram of the application, and the sequence
diagram showing the execution of a command.
...
3.3.3 for the description of `AttackResult`.)
...
.Sequence diagram of attacking the cell a1.
