...
*** Overhaul of UI to display the maps (PRs: https://github.com/CS2103-AY1819S2-W14-3/main/pull/87[#87] )
** Documentation:
*** Restructure the UG to be easier followed when playing the game. (PRs: https://github.com/CS2103-AY1819S2-W14-3/main/pull/256[#256])
** Community:
*** PRs reviewed (with non-trivial review comments):
*** Reported bugs and suggestions for other teams in the class (examples: https://github.com/nus-cs2103-AY1819S2/pe-dry-run/issues/672[#672], https://github.com/nus-cs2103-AY1819S2/pe-dry-run/issues/563[#563] )
** Tools:
