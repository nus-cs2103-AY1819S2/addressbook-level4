...
//        Person personInList = model.getRestOrRant().getPersonList().get(INDEX_SECOND_PERSON.getZeroBased());
//        EditCommand editCommand = new EditCommand(INDEX_FIRST_PERSON,
...
//        assertTrue(outOfBoundIndex.getZeroBased() < model.getRestOrRant().getPersonList().size());
//
