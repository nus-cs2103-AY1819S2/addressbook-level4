...
==== 3.1 A Walk Through (This is a snippet of my actual contributions.)
'''
...
* Crop Command in both User and Developer Guides
* Resize Command in both User and Developer Guides
* Architecture Diagrams in the Developer Guide
