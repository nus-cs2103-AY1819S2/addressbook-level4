...
public class AddCommandSystemTest extends AddressBookSystemTest {
    ...
    public void add() {
         ...
         */
        Person toAdd = AMY;
        String command = "   " + AddCommand.COMMAND_WORD + "  " + NAME_DESC_AMY + "  " + SEMESTER_DESC_AMY + " "
                + EXPECTED_MIN_GRADE_DESC_AMY + "   " + EXPECTED_MAX_GRADE_DESC_AMY + "   " + TAG_DESC_FRIEND + " ";
        ...
        toAdd = new PersonBuilder(HOON).withExpectedMaxGrade(VALID_EXPECTED_MAX_GRADE_BOB).build();
        command = PersonUtil.getAddCommand(toAdd);
        assertCommandFailure(command, AddCommand.MESSAGE_DUPLICATE_PERSON);
     ...
     * 2. {@code Storage} a
     * nd {@code PersonListPanel} equal to the corresponding components in
