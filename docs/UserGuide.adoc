...
The application works primarily through a [CLI]("Command Line Interface")
...
TeethHub allows you to keep track of their patients’
...
Interested in trying TeethHub out? Check section 2 [Prerequisites] to
see what programs you need to have installed in order for TeethHub to
