...
public class EmailTest {
    ...
    public void isValidEmail() {
        ...
        assertFalse(Email.isValidEmail("123@145")); // missing top level domain
        ...
        assertFalse(Email.isValidEmail("!#$%&'*+/=?`{|}~^.-@example.org")); // special characters local part
        assertFalse(Email.isValidEmail("a1+be!@example1.com")); // invalid local part
