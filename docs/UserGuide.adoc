...
Format: `memberAdd n/NAME mn/MATRIC_NUMBER p/PHONE_NUMBER e/EMAIL a/ADDRESS g/GENDER yos/YEAR_OF_STUDY m/MAJOR [t/TAG]...`
****
...
* `memberAdd n/John Doe mn/A0123456Z p/98765432 e/johnd@example.com a/311, Clementi Ave 2, #02-25 g/Male
y/Year 2 m/Chemistry t/Swimming`
* `memberAdd n/Betsy Crower mn/A0654321B p/98765432 e/betsy@example.com a/311, Jurong West Avenue 2, #02-25
g/Female y/Year 2 m/Mathematics t/Swimming`
...
* *Archive an activity* : `activityArchive ACTIVITY_INDEX` +
...
* *Sort all activities by date* : `activitySort`
* *Unarchive an activity* : `activityUnarchive ACTIVITY_INDEX` +
