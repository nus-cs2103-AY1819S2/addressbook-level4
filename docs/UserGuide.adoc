...
These are the information displayed in the result panel when `displayreq` is invoked:
...
. Requirement progress bar and percentage. Informs the user the degree to which he/she have fulfilled the course
requirement.
...
As of `v1.3`, GradTrak has information to keep track of course requirement
