...
For example, you can select and view patients and records by clicking on them, but you would need to type type the edit command to edit them.
...
[cols=",,,",options=""]
|===
|n/NAME |Example: n/Keith Choo Shen Hao

|s/SEX |Example: s/Male

|p/PHONE_NUMBER |Example: p/98765432

|e/EMAIL |Example: e/KeithCSH@debang.com

|a/ADDRESS |Example: a/1 Pulau Tekong Besar 508449

|ic/NRIC |Example: ic/S1234567Z

|age/AGE |Example: age/25

|dob/DATE_OF_BIRTH_DDMMYYYY |Example: dob/28061994

|da/DRUG_ALLERGY |Example: da/Insulin

|nokn/NEXT_OF_KIN_NAME |Example: nokn/Choo Debang

|nokp/NEXT_OF_KIN_PHONE_NUMBER |Example: nokp/97654321

|nokr/NEXT_OF_KIN_RELATION |Example: nokr/Brother

|noka/NEXT_OF_KIN_ADDRESS |Example: noka/21 Lower Kent Ridge Rd 119077
|===
...
delete 2`
Deletes the person shown with index 2 found using the view command.
