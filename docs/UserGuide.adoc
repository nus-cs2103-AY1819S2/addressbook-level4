...
The book _Madame Bovary_ and any other book whose name contains _Madame_ will be displayed.
* `listBook n/Madame n/Madame n/Pride m/6 m/8` +
The book _Madame Bovary_ and _Pride and Prejudice_ will be displayed.
* `listBook n/Madame c/notakeyword`
The invalid prefix will not be recognized. Error message displayed.
* `listBook n/Madame Bovary` +
_Madame Bovary_ is an invalid keyword as it's not a single word. Error message displayed.
