...
Step 2. User sets the block out dates with the respective command. User does not change the max interviews a day and it it set to a default value.
...
** 1b1. Max interviews a day set by using
+
Use case resumes at step 2.
