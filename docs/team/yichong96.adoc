...
The figures below shows us the main Graphical User Interface of Know-It-All,
along with the annotations for each User Interface component.


[.left]
.Home directory, flashcard folders list.
image::inHomeUiPPP.png[width ="400"]

[.right]
.in folder, flashcards list
image::inFolderUiPPP.png[width = '400']
