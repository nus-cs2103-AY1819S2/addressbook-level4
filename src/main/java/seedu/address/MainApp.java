...
import seedu.address.storage.PdfBookStorage;
...
public class MainApp extends Application {
    ...
    public void init() throws Exception {
        logger.info("=============================[ Initializing PdfBook ]===========================");
        super.init();
    ...
    private Model initModelManager(Storage storage, ReadOnlyUserPrefs userPrefs) {
        ...
        try {
            ...
            initialData = addressBookOptional.orElseGet(SampleDataUtil::getSamplePdfBook);
        } catch (DataConversionException e) {
            logger.warning("Data file not in the correct format. Will be starting with an empty PdfBook");
            initialData = new PdfBook();
        } catch (IOException e) {
            logger.warning("Problem while reading from the file. Will be starting with an empty PdfBook");
            initialData = new PdfBook();
        }
    ...
    public void start(Stage primaryStage) {
        logger.info("Starting PdfBook " + MainApp.VERSION);
