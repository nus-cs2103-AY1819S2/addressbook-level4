...
[TIP]
In the panel under the *Client details* label, duplicated names will not appear in the panel because the client details panel only shows distinct number of clients.
...
.Some quick example of commands in Equipment Manager
[[managetable]]
[cols="^.^1,^.^4,^.^2"]
|===
