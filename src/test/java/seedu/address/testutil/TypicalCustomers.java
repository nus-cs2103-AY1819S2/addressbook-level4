...
public class TypicalCustomers {
    ...
    public static final Customer CARL = new seedu.hms.testutil.CustomerBuilder().withName("Carl Kurz").withPhone(
        "95352563")
        .withEmail("heinz@example.com").withAddress("wall street").withIdNum("104535")
        .build();
    public static final Customer DANIEL =
        new seedu.hms.testutil.CustomerBuilder().withName("Daniel Meier").withPhone("87652533")
        .withEmail("cornelia@example.com").withAddress("10th street").withIdNum("12005")
        .withTags("friends").build();
    public static final Customer ELLE = new seedu.hms.testutil.CustomerBuilder().withName("Elle Meyer").withPhone(
        "9482224")
        .withEmail("werner@example.com").withAddress("michegan ave").withIdNum("123300")
        .build();
    public static final Customer FIONA = new seedu.hms.testutil.CustomerBuilder().withName("Fiona Kunz").withPhone(
        "9482427")
        .withEmail("lydia@example.com").withAddress("little tokyo").withIdNum("10095")
        .build();
    public static final Customer GEORGE = new seedu.hms.testutil.CustomerBuilder().withName("George Best").withPhone(
        "9482442")
        .withEmail("anna@example.com").withAddress("4th street").withIdNum("1233999")
        .build();
    public static final Customer VIP_CUSTOMER =
        new seedu.hms.testutil.CustomerBuilder().withName("I am VIP").withPhone("94824425")
        .withEmail("vip@example.com").withAddress("VIP street").withIdNum("2536363")
        .withTags("VIP").build();
    public static final Customer VIP_CUSTOMER2 =
        new seedu.hms.testutil.CustomerBuilder().withName("I am also VIP").withPhone("34824425")
        .withEmail("vip2@example.com").withAddress("VVIP street").withIdNum("5352525")
        .withTags("vip").build();

    // Manually added
    public static final Customer HOON = new seedu.hms.testutil.CustomerBuilder().withName("Hoon Meier").withPhone(
        "8482424")
        .withEmail("stefan@example.com").withIdNum("456363").withAddress("little india").build();
    public static final Customer IDA = new seedu.hms.testutil.CustomerBuilder().withName("Ida Mueller").withPhone(
        "8482131")
