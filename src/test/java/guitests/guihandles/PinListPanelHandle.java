 ...
 */
public class PinListPanelHandle extends NodeHandle<ListView<Person>> {
    public static final String PIN_LIST_VIEW_ID = "#pinListView";

    private static final String CARD_PANE_ID = "#cardPane";

    private Optional<Person> lastRememberedSelectedPersonCard;

    public PinListPanelHandle(ListView<Person> pinListPanelNode) {
        super(pinListPanelNode);
    }
