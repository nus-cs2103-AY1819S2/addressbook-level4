...
public class EditBookCommandParserTest {
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, NAME_DESC_ALICE + AUTHOR_DESC_CS + INVALID_AUTHOR_DESC,
                Author.MESSAGE_CONSTRAINTS);

        // while parsing {@code PREFIX_TAG} alone will reset the tags of the {@code Book} being edited,
        // parsing it together with a valid tag results in error
        assertParseFailure(parser, NAME_DESC_ALICE + TAG_DESC_FANTASY + TAG_DESC_TEXTBOOK + TAG_EMPTY,
                Tag.MESSAGE_CONSTRAINTS);
        assertParseFailure(parser, NAME_DESC_ALICE + TAG_DESC_FANTASY + TAG_EMPTY + TAG_DESC_TEXTBOOK,
                Tag.MESSAGE_CONSTRAINTS);
        assertParseFailure(parser, NAME_DESC_ALICE + TAG_EMPTY + TAG_DESC_FANTASY + TAG_DESC_TEXTBOOK,
                Tag.MESSAGE_CONSTRAINTS);
    ...
    public void parse_multipleRepeatedFields_acceptsLast() {
        ...
        EditBookDescriptor descriptor = new EditBookDescriptorBuilder()
                .withBookName(VALID_BOOKNAME_ALICE).withAuthor(VALID_AUTHOR_ALICE)
    ...
    public void parse_invalidValueFollowedByValidValue_success() {
        ...
        EditBookDescriptor descriptor = new EditBookDescriptorBuilder()
                .withBookName(VALID_BOOKNAME_ALICE).withAuthor(VALID_AUTHOR_CS).build();
        EditBookCommand expectedCommand = new EditBookCommand(predicate, descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);
    ...
    public void parse_resetTags_success() {
        ...
        EditBookDescriptor descriptor = new EditBookDescriptorBuilder()
                .withBookName(VALID_BOOKNAME_ALICE).withTags().build();
        EditBookCommand expectedCommand = new EditBookCommand(predicate, descriptor);
