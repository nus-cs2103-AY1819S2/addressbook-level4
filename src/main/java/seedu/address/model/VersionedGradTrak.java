...
public class VersionedGradTrak extends GradTrak {
    ...
    /**
     * Restores the GradTrak to its previous state.
     */
    public void undo() {
        if (!canUndo()) {
    ...
    /**
     * Restores the GradTrak to its previously undone state.
     */
    public void redo() {
        if (!canRedo()) {
    ...
    /**
     * Returns true if {@code undo()} has GradTrak states to undo.
     */
    ...
    /**
     * Returns true if {@code redo()} has GradTrak states to redo.
     */
