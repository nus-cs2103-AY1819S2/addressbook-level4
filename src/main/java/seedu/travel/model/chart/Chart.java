...
public class Chart {
    ...
    public Chart(Map<CountryCode, Integer> mapCountry,
                 Map<Rating, Integer> mapRating, Map<String, Integer> mapYear) {
        ...
        try {
            ...
            FileWriter fwYear = new FileWriter("data/yearChart.json");
            gson.toJson(mapYear, fwYear);
            fwYear.flush();
        } catch (IOException e) {
