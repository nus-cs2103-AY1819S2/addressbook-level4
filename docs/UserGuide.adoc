...
*When we mention data, we mean the patients list and their respective records plus the task list.* +
 +
You can use `open` to open another .json data file that you may have transferred over from another computer. +
 +
...
You can also use `save` to save your current data to a .pdf, which is nicer on the eyes. +
 +
You can use `import` to add select patients from another .json data file to your current data. +
 +
