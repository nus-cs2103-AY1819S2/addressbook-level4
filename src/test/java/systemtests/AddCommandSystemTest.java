...
public class AddCommandSystemTest extends AddressBookSystemTest {
    ...
    public void add() {
        ...
        /* ------------------------ Perform add operation while a person deck is selected --------------------------- */

        /* Case: selects first deck in the person list, add a person -> added, deck selection remains unchanged */
     ...
     * 5. Browser url and selected deck remain unchanged.<br>
