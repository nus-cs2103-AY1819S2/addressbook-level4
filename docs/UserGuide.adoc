...
****
* Search function can be used to filter those who applied for the job before using this command
****

==== Add a specific person to Job using NRIC : `addPersonToJob`

Adds person with NRIC to "All Applicants" list of a job +
Format : `addAll jn/JOBNAME nric/NRIC`
...
==== Generate Interview Dates : `generateInterviews` `Coming in v1.4`

Generate interview dates for applicants in the Job Hiring Process's "Interview" list
