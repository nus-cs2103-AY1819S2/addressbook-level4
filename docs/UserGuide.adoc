...
e.g. For `import FILEPATH`, `FILEPATH` is a parameter which can be used as `import desktop/photoalbum/image1`.
...
.Invalid Save Name
image::ug_invalidsave.PNG[width="800"]

.Valid Save Name
image::ug_validsave.PNG[width="800"]
