...
. Use different colors for different tags inside card displays. For example, `friends` tags can be all in brown, and `colleagues` tags can be all in yellow.
+
**Before**
+
...
|`* * *` |user |find a card by question |locate details of persons without having to go through the entire list

|`* *` |user |hide <<private-contact-detail,private contact details>> by default |minimize chance of someone else seeing them by accident

|`*` |user with many persons in the address book |sort persons by question |locate a card easily
|=======================================================================
...
. Deleting a card while all persons are listed
