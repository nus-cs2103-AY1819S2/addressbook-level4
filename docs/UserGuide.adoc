...
=== Advanced Operations
All the above operations described above focuses on how individual users may use the app.
However, Know-It-All isn't wasn't designed for individual users in mind. It was designed to be the
application that could empower others to 'Know-It-All' as well.

The following `Import` and `Export` operations describe just how you can share your flashcards with other users and vice versa.
