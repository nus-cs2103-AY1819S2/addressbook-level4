...
public class ListBookCommandParserTest {
    ...
    public void parse_validArgs_returnsFindCommand() {
        ...
        String argsStr1 = PREAMBLE_WHITESPACE + namesStr1 + tagsStr1 + ratingsStr1;
        String argsStr2 = PREAMBLE_WHITESPACE + namesStr2 + tagsStr2 + ratingsStr2;
        String argsStr3 = PREAMBLE_WHITESPACE + namesStr3 + tagsStr3 + ratingsStr3;
