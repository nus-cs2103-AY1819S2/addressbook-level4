...
* Displays a list of medicines running low on stock and a list of expiring/expired medicine batches.
...
If the maximum threshold is set for a list, all medicines and/or batches will be displayed in that list.
=======
...
* `warning show` +
Current thresholds used for the warning panel will be shown in the result display as shown in figure below.
