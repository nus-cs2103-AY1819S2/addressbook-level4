package seedu.pdf.commons.core.index;
...
public class IndexTest {
    ...
    @Test
    public void equals() {
        final Index fifthPdfIndex = Index.fromOneBased(5);

        // same values -> returns true
        assertTrue(fifthPdfIndex.equals(Index.fromOneBased(5)));
        assertTrue(fifthPdfIndex.equals(Index.fromZeroBased(4)));

        // same object -> returns true
        assertTrue(fifthPdfIndex.equals(fifthPdfIndex));

        // null -> returns false
        assertFalse(fifthPdfIndex.equals(null));

        // different types -> returns false
        assertFalse(fifthPdfIndex.equals(5.0f));

        // different index -> returns false
        assertFalse(fifthPdfIndex.equals(Index.fromOneBased(1)));
    }
}
