...
You can use commas (no space) to indicate a break. e.g. `1,3,5` for 1 and 3 and 5 +
You can use dash (no space) to indicate a range. e.g. `3-5` for 3 to 5. `1-3-5` is not allowed, just use `1-5`. +
You can use a combination of commas and dashes to indicate a range as well. e.g. `1-3,5` for 1 to 3 and 5. +
You can also type `all` instead to `import` everything.
============================================================
...
Adds all patients from "data1.json" to the current data.
...
You can use dash (no space) to indicate a range. e.g. `3-5` for 3 to 5. `1-3-5` is not allowed, just use `1-5`. +
You can use a combination of commas and dashes to indicate a range as well. e.g. `1-3,5` for 1 to 3 and 5.
You can also type `all` instead to `export` everything.
============================================================
