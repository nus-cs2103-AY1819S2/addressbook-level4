...
* has a need to manage an inventory
* prefer desktop apps over other types
* requires neat, clean GUI

*Value proposition*: efficient storage, display and organisation of data to make inventory management easier.
