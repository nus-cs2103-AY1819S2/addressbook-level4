...
public class EditCommandSystemTest extends CardFolderSystemTest {
    ...
    public void edit() {
        ...
        assertTrue(getModel().getCardFolder().getPersonList().contains(BOB));
        ...
        /* Case: filtered person list, edit index within bounds of card folder and person list -> edited */
        ...
        /* Case: filtered person list, edit index within bounds of card folder but out of bounds of person list
         * -> rejected
         */
        showPersonsWithName(KEYWORD_MATCHING_MEIER);
