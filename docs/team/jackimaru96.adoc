...
budget
** [red]#*_Highlights of feature:_*#
*** This feature will be updated every time a user `[fuchsia]#spends#`, `[fuchsia]#edit#` the amount in the records, or
...
and https://github.com/CS2103-AY1819S2-W17-3/main/projects?query=is%3Aclosed[here] to view the Project I managed
