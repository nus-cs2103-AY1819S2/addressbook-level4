...
public class RecordDeleteCommand extends Command {
    ...
    public RecordDeleteCommand(Index targetIndex) {
    ...
    public boolean equals(Object other) {
        return other == this // short circuit if same object
                || (other instanceof RecordDeleteCommand // instanceof handles nulls
                && targetIndex.equals(((RecordDeleteCommand) other).targetIndex)); // state check
    }
}
