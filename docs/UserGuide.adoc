...
As you set up RestOrRant to reflect your physical restaurant or add tables in the event that there are new tables in your restaurant, this command allows you to add tables in RestOrRant by specifying the number of seats at the table.
...
[[Daily]]
==== Getting the daily revenue : `daily`
...
[[Monthly]]
==== Getting the monthly revenue : `monthly`

Change the interface to display the statistical monthly revenue. +
Format: `monthly`

[[Yearly]]
==== Getting the yearly revenue : `yearly`
