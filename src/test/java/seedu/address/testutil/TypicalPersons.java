...
public class TypicalPersons {
    ...
    public static final Cell CARL = new PersonBuilder().withName("Carl Kurz").withPhone("95352563")
            .withEmail("heinz@example.com").withAddress("wall street").build();
    public static final Cell DANIEL = new PersonBuilder().withName("Daniel Meier").withPhone("87652533")
            .withEmail("cornelia@example.com").withAddress("10th street").withTags("friends").build();
    public static final Cell ELLE = new PersonBuilder().withName("Elle Meyer").withPhone("9482224")
            .withEmail("werner@example.com").withAddress("michegan ave").build();
    public static final Cell FIONA = new PersonBuilder().withName("Fiona Kunz").withPhone("9482427")
            .withEmail("lydia@example.com").withAddress("little tokyo").build();
    public static final Cell GEORGE = new PersonBuilder().withName("George Best").withPhone("9482442")
    ...
    public static final Cell AMY = new PersonBuilder().withName(VALID_NAME_AMY).withPhone(VALID_PHONE_AMY)
    ...
    public static MapGrid getTypicalAddressBook() {
        ...
        for (Cell cell : getTypicalPersons()) {
            ab.addPerson(cell);
        }
        return ab;
    }
