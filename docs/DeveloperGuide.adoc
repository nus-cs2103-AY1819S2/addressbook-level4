...
1. User enter select command followed by index
...
** 1a2. User have to reenter command
+
...
** 1b2. User have to reenter command
+
Use case resumes from step 1.
[none]
* 3a. User enter “undo”
...
1. User enter command to view patient history with index
