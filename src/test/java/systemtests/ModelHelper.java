...
public class ModelHelper {
    private static final Predicate<Place> PREDICATE_MATCHING_NO_PERSONS = unused -> false;
    ...
    public static void setFilteredList(Model model, List<Place> toDisplay) {
        ...
        model.updateFilteredPlaceList(predicate.orElse(PREDICATE_MATCHING_NO_PERSONS));
    }
