...
** Project management:
*** Made changes to the project that do not fall under a specific feature e.g renaming the app header title and icon (Pull Requests https://github.com/CS2103-AY1819S2-W14-3/main/pull/352[#352], https://github.com/CS2103-AY1819S2-W14-3/main/pull/240[#240], https://github.com/CS2103-AY1819S2-W14-3/main/pull/176[#176])
