...
public class SelectCommandSystemTest extends MapGridSystemTest {
    @Test
    public void select() {
        /* ------------------------ Perform select operations on the shown unfiltered list -------------------------- */

        /* Case: select the first card in the cell list, command with leading spaces and trailing spaces
         * -> selected
         */
        String command = "   " + SelectCommand.COMMAND_WORD + " " + INDEX_FIRST_PERSON.getOneBased() + "   ";
        assertCommandSuccess(command, INDEX_FIRST_PERSON);

        /* Case: select the last card in the cell list -> selected */
        ...
        /* Case: select the middle card in the cell list -> selected */
        ...
        /* Case: filtered cell list, select index within bounds of address book but out of bounds of cell list
         * -> rejected
         */
        ...
        /* Case: filtered cell list, select index within bounds of address book and cell list -> selected */
     ...
     * {@code expectedSelectedCardIndex} of the selected cell.<br>
