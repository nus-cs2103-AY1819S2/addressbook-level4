...
* TO-DO: filtering is not redone or undone with undo and redo commands, this will be implemented in v1.2
* TO-DO: filtering is not implemented for tag criteria. This will also be added in v1.2
****
