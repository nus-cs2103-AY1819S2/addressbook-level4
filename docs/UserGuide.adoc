...
The maps will be displayed as follows:

image::initmapresult.png[width=600]
...
- Water - Empty (no ship) player cell that has not been hit
- Water Hit - Empty player cell that has been hit
...
The diagram below shows which colour represents which status.

image::maplegend.png[width=300]
