...
* **Alternative 1 (current choice):** Display previous folder scores in a graph
** Pros: More visual, easier to see change in folder score.
** Cons: More performance and memory intensive as a graph needs to be rendered. Remedy: dispaly only last ten.
* **Alternative 2:** List the previous folder scores
** Pros: User can see more accurate numbers
