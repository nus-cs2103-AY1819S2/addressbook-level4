...
[NOTE]
To CS2103T peer reviewers, please refer to the PDF document uploaded to LumiNUS instead of this GitHub page. The PDF document is better formatted and nicely features only the most important components. Thank you!
...
include::../UserGuide.adoc[tag=addfolder]

include::../UserGuide.adoc[tag=editfolder]
