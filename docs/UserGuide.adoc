...
image::ep_before.png[width="600" align="center"]
...
allowed in QuickDocs. When you edit a patient's NRIC/FIN and there is an existing patient with that NRIC, the current edit
...
have started for the current patient. A text indicating that the consultation session have started for the particular patient will also
...
If you made a mistake when entering the diagnosis, you can always rectify it by reentering the `diagnose` command with the correct
