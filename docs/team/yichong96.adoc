...
`command`: A monospace font indicates that this is a command
that can be inputted into the command line and executed by the application.

[red]#text# : represents methods, variables or classes found within the Java files.
