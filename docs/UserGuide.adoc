...
Don't worry about the commands not being able to be used in your current mode, for the Suggestion commands will only suggest commands that can be used in your current mode.

For example, if you were to type `add` in Patient Mode, this is what you will see:

image::SuggestionFeatureAddPatientMode.png[width="236"]

If you were to type `add` in Record Mode, this is what you will see instead:
