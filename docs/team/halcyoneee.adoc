...
As part of the Software Engineering Module, CS2103T, at National University of Singapore, the
team comprises of 5 members were tasked to develop and enhance an existing
https://github.com/se-edu/addressbook-level4[address book application] within 7
weeks.
...
*** Contributed to `HelpCommand`, `ListLessonCommand`, `OpenLessonCommand` and `QuizAnswerCommand`
system tests to increase coverage from 88% to 95%
(https://github.com/CS2103-AY1819S2-W14-1/main/pull/175[#175])
...
|===
|_Given below are an extract of my contributions on Quiz Mode to the User Guide. They showcase my
 ability to write documentation targeting our end-user - Students and Creators._
|===
...
|===
|_Given below are an extract of my contribution on Quiz Mode to the Developer Guide. They
showcase my ability to write technical documentation and the technical depth of my contributions to the project._
|===
