...
public class SampleBloodCards {
    ...
    // Manually added
    public static final Card CARD_8 = new CardBuilder().withQuestion("Patients with Acute lymphoblastic leukaemia with philadelphia chromosome cytogenic changes will require what special treatment?")
            .withAnswer("Imatinib")
            .withScore("0/0")
            .build();
    ...
    public static final Card CARD_10 = new CardBuilder().withQuestion("_____ is the iron-containing oxygen-transport metalloprotein in the red blood cells")
