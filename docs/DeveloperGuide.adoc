...
Every single one of the persons in the 'persons' paremeter is traversed.
...
* 'filter or/and [n/NAME/n] [p/PHONE/p] [e/EMAIL/e] [a/ADDRESS/a] [skill/ SKILL1, SKILL2, …​ /skill]'
* 'filter clear'
...
to 'available'
* for the available parameters, the input is trimmed and separated from the prefixes.
