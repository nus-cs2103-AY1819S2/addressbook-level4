...
* A phrase in _italics_ indicates that it is either a Figure label or a referrence to a Figure.
====
...
** Documentation:
*** Added user stories, use cases and and Non-Functional Requirements (PR https://github.com/CS2103-AY1819S2-W17-1/main/pull/22[#22])
