...
public class CommandTestUtil {
    ...
    public static final String INVALID_GENDER_DESC = " " + PREFIX_GENDER + "x"; // not known gender
    ...
    static {
        DESC_AMY = new EditPersonDescriptorBuilder().withName(VALID_NAME_AMY)
                .withPhone(VALID_PHONE_AMY).withEmail(VALID_EMAIL_AMY).withGender(VALID_GENDER_AMY).withRace(VALID_RACE_AMY)
        ...
        DESC_BOB = new EditPersonDescriptorBuilder().withName(VALID_NAME_BOB)
                .withPhone(VALID_PHONE_BOB).withEmail(VALID_EMAIL_BOB).withGender(VALID_GENDER_BOB).withRace(VALID_RACE_BOB)
