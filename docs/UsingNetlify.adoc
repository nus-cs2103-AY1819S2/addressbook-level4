...
* View your main branch's deployed documentation on the site question given by Netlify (customizable as shown <<Changing the site question of your project, below>>).
+
image:netlify/temp_site_name.png[Temporary site question, width = 630]
+
...
== Changing the site question of your project
If you don't like the site question given by Netlify, you can change it as follows:

. Click on `Settings`.
+
. Then click `Change site question` and fill in your desired site question.
+
image:netlify/change_site_name.png[Change site question, width = 630]
