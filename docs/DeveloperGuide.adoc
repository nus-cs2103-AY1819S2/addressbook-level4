...
.Screenshot of empty statistics pop-up window.
...
.Screenshot of populated statistics pop-up window.
...
.Sequence diagram of `stats` command.
...
.Sequence diagram of how the statistics data is saved.

The following sequence diagram summarizes what happens at the end of the game where an automatic reading of previous
statistics data is performed.

image::ReadSequenceDiagram.PNG[width=600]
.Sequence diagram of how the previous statistics data is read from storage.

==== Activity Diagram
The following Activity Diagram shows when the `stats` command can be used.

image::StatisticsActivityDiagram.png[width=1000]
.Activity Diagram of the statistics feature.

==== Use Case Diagram
The following use-case diagram captures the behaviour of the statistics feature.

image::StatsUseCaseDiag.PNG[width=500]
.Use case diagram on the statistics feature.
