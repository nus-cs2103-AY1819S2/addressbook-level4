...
public class SelectCommandSystemTest extends AddressBookSystemTest {
    ...
    public void select() {
        ...
        /* Case: filtered medicine list, select index within bounds of address book but out of bounds of medicine list
         * -> rejected
         */
        ...
        /* Case: filtered medicine list, select index within bounds of address book and medicine list -> selected */
