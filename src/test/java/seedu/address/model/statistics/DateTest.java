...
public class DateTest {
    ...
    public void isValidDate() {
        ...
        assertTrue(Date.isValidDate("31.01.2019", new Day("31"), new Month("1"), new Year("2019")));
        assertTrue(Date.isValidDate("31.01.2019", new Day("31"), new Month("03"), new Year("2019")));
        assertTrue(Date.isValidDate("31.01.2019", new Day("31"), new Month("05"), new Year("2019")));
        assertTrue(Date.isValidDate("30.11.2018", new Day("30"), new Month("07"), new Year("2019")));
        assertTrue(Date.isValidDate("31.01.2019", new Day("31"), new Month("08"), new Year("2019")));
        assertTrue(Date.isValidDate("31.01.2019", new Day("31"), new Month("10"), new Year("2019")));
        assertTrue(Date.isValidDate("31.01.2019", new Day("31"), new Month("12"), new Year("2019")));
        ...
        assertFalse(Date.isValidDate("31.11.2018", new Day("31"), new Month("04"), new Year("2018")));
        assertFalse(Date.isValidDate("31.11.2018", new Day("31"), new Month("06"), new Year("2018")));
        assertFalse(Date.isValidDate("31.11.2018", new Day("31"), new Month("09"), new Year("2018")));
