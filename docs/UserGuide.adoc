...
The image below shows the result of using `select 3` command. The place with an index of 3 is highlighted in a blue box and additional information is shown on the right side of the GUI.
