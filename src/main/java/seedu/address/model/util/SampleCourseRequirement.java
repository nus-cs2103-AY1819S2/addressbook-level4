...
public class SampleCourseRequirement {
    ...
    public static final String ULR_PATTERN = "(GE)(T|S|R|H|Q)1[0-9]{3}[A-Z]?";
    public static final Condition ULR_CONDITION = new Condition(5, ULR_PATTERN);
    ...
    public static final CourseRequirement IT_PROFESSIONALISM = new PrimitiveRequirement("IT Professionalism",
