...
TeethHub allows you to keep track of your patients’ patiental particulars along with their dental records.
...
indicate patientalised note describing more detail on the patient’s teeth
health.

=== List
Shows a list of all patientnel or medical stored in the application

Format: `list [dental]`

Command shows patientnel details by default, add dental to see dental
records.
...
=== Clear
Clears all patientnel data and records from the application.
...
=== Exit anyway
Exits the program, disregardign any copies.
