...
public class MainApp extends Application {
    ...
    public void init() throws Exception {
        logger.info("=============================[ Initializing BookShelf ]===========================");
        super.init();
        ...
        BookShelfStorage bookShelfStorage = new JsonBookShelfStorage(userPrefs.getAddressBookFilePath());
        storage = new StorageManager(addressBookStorage, bookShelfStorage, userPrefsStorage);
    ...
    public void start(Stage primaryStage) {
        logger.info("Starting BookShelf " + MainApp.VERSION);
