...
public class TypicalRestaurants {
    ...
    public static final Restaurant BENSON = new RestaurantBuilder().withName("Benson Meier")
            ...
            .withEmail("johnd@example.com").withPhone("98765432").withWeblink("https://www.google.com")
