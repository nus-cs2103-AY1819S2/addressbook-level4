...
public class MedicalHistoryTest {
    ...
    public void equals() {
        MedicalHistory mh1 = new MedicalHistory(
                1, 1, new ValidDate(LocalDate.parse("2018-05-05")), new WriteUp("testWriteUp"));
        MedicalHistory mh2 = new MedicalHistory(
                1, 2, new ValidDate(LocalDate.parse("2018-05-05")), new WriteUp("testWriteUp"));
        MedicalHistory mh3 = new MedicalHistory(
                1, 1, new ValidDate(LocalDate.parse("2018-05-06")), new WriteUp("testWriteUp"));
