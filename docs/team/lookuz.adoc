...
As my team and I morphed the original implementation of AddressBook4 to
...
include::../UserGuide.adoc[tags=addHealthWorker]

include::../UserGuide.adoc[tags=editHealthWorker]

include::../UserGuide.adoc[tags=listHealthWorker]

include::../UserGuide.adoc[tags=delHealthWorker]

include::../UserGuide.adoc[tags=filterHealthWorker]
