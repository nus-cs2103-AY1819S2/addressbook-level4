...
public class JsonAdaptedCustomerTest {
    ...
    public void toModelTypeNullNameThrowsIllegalValueException() {
        JsonAdaptedCustomer customer = new JsonAdaptedCustomer(null, VALID_PHONE, VALID_EMAIL,
            VALID_IDENTIFICATION_NO, VALID_ADDRESS,
            VALID_TAGS);
    ...
    public void toModelTypeNullPhoneThrowsIllegalValueException() {
        JsonAdaptedCustomer customer = new JsonAdaptedCustomer (VALID_NAME, null, VALID_EMAIL, VALID_IDENTIFICATION_NO, VALID_ADDRESS, VALID_TAGS);
    ...
    public void toModelTypeNullEmailThrowsIllegalValueException() {
        JsonAdaptedCustomer customer = new JsonAdaptedCustomer
            (VALID_NAME, VALID_PHONE, null, VALID_IDENTIFICATION_NO, VALID_ADDRESS, VALID_TAGS);
