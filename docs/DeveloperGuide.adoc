...
=== Use case: Arrange interview dates

*MSS*

1. User requests to arrange interview dates for applicants
2. slaveFinder() shows a ranked list of interviewees
3. slaveFinder() asks for confirmation of interviewees
4. slaveFinder() assigns to each interviewee a date and shows it to user
5. slaveFinder() asks for confirmation of dates
6. slaveFinder() ask User for confirmation of interviewees and dates
7. Email is sent to the interviewees

*Extensions*

* 3a. User is not satisfied with the interviewees
* 3b. User removes unwanted interviewees +
Use case resumes at step 4.

* 5a. User is not satisfied with the dates
* 5b. User rearranges dates +
