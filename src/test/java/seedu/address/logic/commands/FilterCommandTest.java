...
public class FilterCommandTest {
    ...
    @Test
    public void execute_oneCondition_at_one_filter() {
    ...
    @Test
    public void execute_filterClear_at_one_filter_active() {
    ...
    @Test
    public void execute_filterClear_at_multiple_filters_active() {
    ...
    @Test
    public void execute_allConditions_at_one_filter() {
        String[] skillArr = {"friends"};
