...
and is defaulted to the start range. +

*Storage* +
Behind the scenes, the Statistics objects are retrieved from Record objects, sorted by months with RecordMonth objects in
the RecordManager class.

*Process* +
The command is first entered, e.g. `stats finances 0119`. LogicManager will execute
