...
public class Messages {
    ...
    public static final String MESSAGE_LACK_FILTERNAME = "Filter Command in Display Job page need a name";
    public static final String MESSAGE_LACK_LISTNAME = "Filter Command in Display Job page need indicate job list";
    public static final String MESSAGE_REDUNDANT_FILTERNAME = "Filter Command in All Jobs page don't need a name";
