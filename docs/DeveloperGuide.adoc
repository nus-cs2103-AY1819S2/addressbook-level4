...
+
[none]
** 2a1. RestOrRant Program returns an error message that it is already in Restaurant Mode.
+
Use case ends.
...
2. RestOrRant Program changes the UI to show the menu in the list panel, and allows addToMenu command.
+
Use case ends.
...
+
[none]
** 1a1. RestOrRant Program returns an message that program is already in menu mode.
+
Use case ends.


[discrete]
=== Use case: Adding tables to the RestOrRant Program
...
2.  RestOrRant Program returns the status (number of customers at the table/number of seats at the table) of all tableList in the restaurant.
+
Use case ends.
...
+
[none]
** 2a1. RestOrRant Program returns an error message that there are no tableList in the restaurant.
+
Use case ends.
...
2.  RestOrRant Program updates the specified table's order with the menu items and displays the new order list.
+
Use case ends.
...
+
[none]
** 1a1. RestOrRant Program displays the item codes that are invalid and remove them from the list of item codes to add to the order.
+
...
+
[none]
** 1a1. RestOrRant Program prints out "Invalid arguments. All arguments should be a numercial number. Format: getStatistics [Year] [Month] [Date]".
+
Use case ends.
