...
=== Global Operations
The commands shown in this section are applicable in multiple locations.
...
[NOTE]
This command is only valid in a folder or the home directory.
...
[NOTE]
This command is valid anywhere in the application.
