...
Overall, my role in this project encompasses managing the UI components, Statistics feature, project deadline and
deliverable. The following provides a detailed summary of the coding, documentation and other helpful contributions
