...
Both yourself and the computer AI will not be able to place ships on the black tiles. The enemy AI will also have a randomised map that will not be the same as your map. You will not be able to see the shape of the enemy map and can shoot black cells which will be counted as a miss.
