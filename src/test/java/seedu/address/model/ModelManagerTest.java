...
import static seedu.address.testutil.TypicalObject.BENSON;
...
public class ModelManagerTest {
    ...
    public void equals() {
        ...
        modelManager.updateBaseFilteredPersonList(new NameContainsKeywordsPredicate(Arrays.asList(keywords)));
        assertFalse(modelManager.equals(new ModelManager(addressBook, userPrefs)));

        // resets modelManager to initial state for upcoming tests
        modelManager.updateBaseFilteredPersonList(PREDICATE_SHOW_ALL_PERSONS);
