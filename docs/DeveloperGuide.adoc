...
Blood.csv
    ...
    If patient has raised WBC count, raised platelet and raised Hb count, he is likely to have _____.,myeloproliferative neoplasm, ,friends,
    For _____, besides systemic chemo, treatment includes chemo injections into scrotum and CSF.,acute lymphoblastic leukemia, ,colleagues,friends,
    Commonly used anti-fibrinolytic drug is _____, which prevent activation of plasminogen to plasmin,tranexamic acid, ,neighbours,
    -penia means too _____,few, ,family,
    -philia means too,many, ,classmates,
    -cytosis means too,many, ,friends,
    Myelodysplasia often regresses into what blood disorder?,Acute Leukaemia, ,colleagues,friends,
    Patients with Acute lymphoblastic leukaemia with philadelphia chromosome cytogenic changes will require what special treatment?,Imatinib, ,neighbours,
    Burkitt lymphoma is associated with what virus?,EBV, ,family,
    _____% of circulating neutrophils are in marginating pool, hence not counted in full blood count,50, ,family,
