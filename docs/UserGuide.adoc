...
* **`add`**`n/John Doe p/98765432 e/johnd@example.com nric/S9671597H g/Male r/Indian a/311, Clementi Ave 2, #02-25 s/NUS m/Computer Science gr/4.76 j/Software-Engineer is/1,2,3,4,5 kpl/Python pj/Software Engineer` : adds a contact named `John Doe` to the Address Book.
...
* `n/John Doe p/98765432 e/johnd@example.com nric/S9671597H g/Male r/Indian a/311, Clementi Ave 2, #02-25 s/NUS m/Computer Science gr/4.76 j/Software-Engineer is/1,2,3,4,5 kpl/Python pj/Software Engineer`
...
==== Adds people using by index to a selected list in a Job : `movePeople`
 ...
 Moves a few people specified by index from a specified list to a +
