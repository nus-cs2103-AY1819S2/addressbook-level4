...
[aqua]#You can use this command to set a budget for the current instance of _In-Credit-Ble_ Finance Tracker.# +
...
[aqua]#You can use this command to set a budget for a category in _In-Credit-Ble_ Finance Tracker.# +
...
and cannot contain special characters such as `[fuchsia]#:<>;\/|?~^%$#@#`
...
[aqua]#You can use this command to see your current spending and the category budget allocated in
