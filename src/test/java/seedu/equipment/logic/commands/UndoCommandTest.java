...
public class UndoCommandTest {
    ...
    private final Model model = new ModelManager(getTypicalEquipmentManager(), new UserPrefs());
    private final Model expectedModel = new ModelManager(getTypicalEquipmentManager(), new UserPrefs());
