...
import static seedu.travel.logic.commands.SelectCommand.MESSAGE_SELECT_PLACE_SUCCESS;
...
public class SelectCommandSystemTest extends TravelBuddySystemTest {
    @Test
    public void select() {
        ...
        Index placeCount = getLastIndex(getModel());
        ...
        /* Case: filtered place list, select index within bounds of travel book but out of bounds of place list
         * -> rejected
         */
        ...
        /* Case: filtered place list, select index within bounds of travel book and place list -> selected */
        Index validIndex = Index.fromOneBased(1);
        assertTrue(validIndex.getZeroBased() < getModel().getFilteredPlaceList().size());
        ...
        /* Case: select from empty travel book -> rejected */
        deleteAllPlaces();
     ...
     * {@code expectedSelectedCardIndex} of the selected place.<br>
