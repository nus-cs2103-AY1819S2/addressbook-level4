...
In this section, we'll walk you through the user interface of the application and how to create your first flashcard.

[TIP]
To use a command, type the command in the command box and press kbd:[enter] to execute it. +
e.g. typing *`help`* and pressing kbd:[enter] will open the help window. +

. When booting up the app for the first time, you should see the home directory much like the screengrab below. The first and only folder present is a sample folder named none other than "Sample Folder".
+
image::AnnotatedStartupUI.png[width="500"]

. *`cd`* `1` : enter the 1st flashcard folder. You will see that you have entered the sample folder.
+
...
. *`select 4`* : selects the first flashcard in the current folder
...
Creates a folder with the name "Nervous System". The user can then enter the folder with the `cd` command and begin adding cards.
