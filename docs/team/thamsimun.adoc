...
*** Integrated Netlify to the team repository (https://github.com/CS2103-AY1819S2-W14-2/main/issues/151[#151])
*** Integrated AppVeyor to the team repository
(https://github.com/CS2103-AY1819S2-W14-2/main/issues/151[#151])
...
include::../DeveloperGuide.adoc[tag=SavePreset]
