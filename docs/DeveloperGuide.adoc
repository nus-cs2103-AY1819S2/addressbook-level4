...
1.  The actor requests all the reservations a customer has.
2.  The system lists the reservations requested.
3.  The actor requests to delete a specific reservation.
...
* 3b. The staff requests to stop deleting the reservation.
+
Use case ends.
...
1. The actor requests the lists of all the customers.
...
+
[none]
** 3b1. The system generates total bill for a different customer, not the intended one.
+
Use case resumes at step 3.
