...
ifdef::env-github[]
a| :white_check_mark: | Expected result after executing the command
...
|===
ifdef::env-github[a| :white_check_mark: a| The help window will open.]
...
[width="100%",cols="5%,95%", grid=none]
|===
ifdef::env-github[a| :white_check_mark: a| The list of past commands will be shown in the Results Display.]
...
[width="100%",cols="5%,95%", grid=none]
|===
ifdef::env-github[a| :white_check_mark: a| All data in RestOrRant will be deleted and the side and main panels will be empty.]
...
[width="100%",cols="5%,95%", grid=none]
|===
ifdef::env-github[a| :white_check_mark: a| RestOrRant exits and the application window closes.]
...
[width="100%",cols="5%,95%", grid=none]
|===
ifdef::env-github[a| :white_check_mark: a| The user interface switches to <<Restaurant Mode, Restaurant Mode>>.]
...
[width="100%",cols="5%,95%", grid=none]
|===
ifdef::env-github[a| :white_check_mark: a| The user interface switches to <<Table Mode, Table Mode>>.]
...
[width="100%",cols="5%,95%", grid=none]
|===
ifdef::env-github[a| :white_check_mark: a| The user interface switches to <<Menu Mode, Menu Mode>>.]
...
[width="100%",cols="5%,95%", grid=none]
|===
ifdef::env-github[a| :white_check_mark: a| icon:check[role="green", size="2x"] a| The user interface switches to <<Statistics Mode, Statistics Mode>>.]
...
[width="100%",cols="5%,95%", grid=none]
|===
ifdef::env-github[a| :white_check_mark: a|]
