...
the player's map when the player ends their turn.
...
magic in the background, as shown in the following use case diagram:

image::EnemyUseCaseDiagram.png[width=600]
