...
public class JsonAdaptedPlaceTest {
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedPlace place =
                new JsonAdaptedPlace(INVALID_NAME, VALID_PHONE, VALID_DESCRIPTION, VALID_ADDRESS, VALID_TAGS);
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        JsonAdaptedPlace place = new JsonAdaptedPlace(null, VALID_PHONE, VALID_DESCRIPTION,
    ...
    public void toModelType_invalidPhone_throwsIllegalValueException() {
        JsonAdaptedPlace place =
                new JsonAdaptedPlace(VALID_NAME, INVALID_PHONE, VALID_DESCRIPTION, VALID_ADDRESS, VALID_TAGS);
    ...
    public void toModelType_invalidDescription_throwsIllegalValueException() {
        JsonAdaptedPlace place =
                new JsonAdaptedPlace(VALID_NAME, VALID_PHONE, INVALID_DESCRIPTION, VALID_ADDRESS, VALID_TAGS);
    ...
    public void toModelType_invalidAddress_throwsIllegalValueException() {
        JsonAdaptedPlace place =
                new JsonAdaptedPlace(VALID_NAME, VALID_PHONE, VALID_DESCRIPTION, INVALID_ADDRESS, VALID_TAGS);
    ...
    public void toModelType_nullAddress_throwsIllegalValueException() {
        JsonAdaptedPlace place = new JsonAdaptedPlace(VALID_NAME, VALID_PHONE, VALID_DESCRIPTION, null, VALID_TAGS);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedPlace place =
                new JsonAdaptedPlace(VALID_NAME, VALID_PHONE, VALID_DESCRIPTION, VALID_ADDRESS, invalidTags);
