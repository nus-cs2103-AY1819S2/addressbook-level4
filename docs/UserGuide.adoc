...
set budget for `Clothes` category. In addition, your last category must be of correct format (see below)
...
expenditure in the future. (For e.g. if you allocated $50.00 to `Clothes` and have yet to spend anything in the
