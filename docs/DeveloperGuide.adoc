...
[discrete]
=== Use case: Setting categories of a Restaurant

*MSS*

1. FoodLover enters command, index and categories to set to the restaurant
2. FoodDiary updates the categories entered, leaving unentered categories unedited
+
Use case ends.
...
* 1a. FoodLover enters an invalid index
[none]
** 1a1. FoodDiary shows invalid command format
+
Use case ends.

[none]
* 2a. FoodLover enters invalid category prefix
[none]
** 2a1. FoodDiary shows invalid command format
+
Use case ends.

[discrete]
=== Use case: Filtering Restaurants in FoodDiary (cuisine, occasion, price)

*MSS*

1. FoodLover enters command and keywords to filter by.
2. FoodDiary displays restaurant’s that match the keywords.
+
Use case ends.
