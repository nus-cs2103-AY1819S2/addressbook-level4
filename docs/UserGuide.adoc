...
|===
a| icon:check[role="green", size="2x"] a| The help window will open.
|===
...
[width="100%",cols="5%,95%", grid=none]
|===
a| icon:check[role="green", size="2x"] a| The list of past commands will be shown in the Results Display.
|===
...
[width="100%",cols="5%,95%", grid=none]
|===
a| icon:check[role="green", size="2x"] a| All data in RestOrRant will be deleted and the side and main panels will be empty.
|===
...
[width="100%",cols="5%,95%", grid=none]
|===
a| icon:check[role="green", size="2x"] a| RestOrRant exits and the application window closes.
|===
...
[width="100%",cols="5%,95%", grid=none]
|===
a| icon:check[role="green", size="2x"] a| The user interface switches to <<Restaurant Mode, Restaurant Mode>>.
|===
...
[width="100%",cols="5%,95%", grid=none]
|===
a| icon:check[role="green", size="2x"] a| The user interface switches to <<Table Mode, Table Mode>>.
...
[width="100%",cols="5%,95%", grid=none]
|===
a| icon:check[role="green", size="2x"] a| The user interface switches to <<Menu Mode, Menu Mode>>.
|===
...
[width="100%",cols="5%,95%", grid=none]
|===
a| icon:check[role="green", size="2x"] a| The user interface switches to <<Statistics Mode, Statistics Mode>>.
|===
// end::changemode[]
...
[width="100%",cols="5%,95%", grid=none]
|===
a| icon:check[role="green", size="2x"] a|
