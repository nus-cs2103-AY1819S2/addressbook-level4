...
public class FilterCommandParserTest {
    ...
    public static final String NON_EXISTING_PREFIX_REVERSE = "/h";
    public static final String VALID_NAME1 = PREFIX_NAME + VALID_NAME_AMY + PREFIX_NAME_REVERSE;
    public static final String MISSING_BEGIN_PREFIX_EMAIL = VALID_EMAIL_AMY + PREFIX_EMAIL_REVERSE;
    public static final String MISSING_END_PREFIX_ADDRESS = PREFIX_ADDRESS + VALID_ADDRESS_AMY;
    public static final String MISSING_END_PREFIX_EDUCATION = PREFIX_EDUCATION + VALID_GPA_AMY;
    ...
    public void parse_invalidPrefixPair_failure() {
        ...
        assertParseFailure(parser, AND_TYPE + MISSING_END_PREFIX_ADDRESS, MESSAGE_INVALID_FORMAT);

        // only ending prefix is used
        assertParseFailure(parser, OR_TYPE + MISSING_BEGIN_PREFIX_EMAIL, MESSAGE_INVALID_FORMAT);

        // false beginning and ending prefix couples are used
        assertParseFailure(parser, AND_TYPE + MISSING_END_PREFIX_EDUCATION + PREFIX_GPA_REVERSE,
                MESSAGE_INVALID_FORMAT);

        // non-existing prefix is used
        assertParseFailure(parser, OR_TYPE + NON_EXISTING_PREFIX + "someText"
                + NON_EXISTING_PREFIX_REVERSE, MESSAGE_INVALID_FORMAT);
    }
