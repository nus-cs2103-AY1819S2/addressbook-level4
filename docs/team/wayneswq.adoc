...
** Justification: In a busy clinic with many patients, the user must be able to manage patient efficiently.
...
* *Minor enhancement*: enhanced the user display of both patients and doctor.
** What it does: allows unrestricted view of pid and did, and viewing of patient's appointment status
** Justification: This enables other components, such as appointments, to view and use the info for their commands accordingly.
