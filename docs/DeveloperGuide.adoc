...
* Adding an equipment: `AddCommand`
* Editing an equipment: `EditCommand`
* Deleting an equipment `DeleteCommand`
* Listing all equipment: `ListCommand`
...
[TIP]
`SortCommand` only supports sorting by address and phone number.
