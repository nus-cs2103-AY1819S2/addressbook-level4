...
public class UserPrefsTest {
    ...
    public void setMenuFilePath_nullPath_throwsNullPointerException() {
        ...
        Assert.assertThrows(NullPointerException.class, () -> userPrefs.setMenuFilePath(null));
    }

    @Test
    public void setOrdersFilePath_nullPath_throwsNullPointerException() {
        UserPrefs userPrefs = new UserPrefs();
        Assert.assertThrows(NullPointerException.class, () -> userPrefs.setOrdersFilePath(null));
    }

    @Test
    public void setTablesFilePath_nullPath_throwsNullPointerException() {
        UserPrefs userPrefs = new UserPrefs();
        Assert.assertThrows(NullPointerException.class, () -> userPrefs.setTablesFilePath(null));
    }

    @Test
    public void setStatisticsFilePath_nullPath_throwsNullPointerException() {
        UserPrefs userPrefs = new UserPrefs();
        Assert.assertThrows(NullPointerException.class, () -> userPrefs.setStatisticsFilePath(null));
    }
