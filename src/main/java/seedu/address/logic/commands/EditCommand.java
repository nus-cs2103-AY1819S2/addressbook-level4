...
public class EditCommand extends Command {
    ...
    public static final String MESSAGE_USAGE = COMMAND_WORD + ": Edits the details of the cell identified "
            + "by the index number used in the displayed cell list. "
    ...
    public static final String MESSAGE_EDIT_PERSON_SUCCESS = "Edited Cell: %1$s";
