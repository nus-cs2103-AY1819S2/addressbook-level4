...
Change the interface to display the statistical dailyly revenue. +
Format: `daily`
...
|`help` | kbt:[F1] | `help` | Shows the user guide
...
|`deleteFromOrder` | - | `deleteFromOrder ITEM_CODE` | `deleteFromOrder W09` +
...
|`daily`|`d`|`daily` |`daily` +
Changes the interface to display the statistical daily revenue.
|`monthly`|`m`|`monthly` |`monthly` +
Changes the interface to display the statistical monthly revenue.
|`yearly`|`y`|`yearly` |`yearly` +
Changes the interface to display the statistical yearly revenue.
|=======================================================================
