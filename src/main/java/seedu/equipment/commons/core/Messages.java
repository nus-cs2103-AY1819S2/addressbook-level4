package seedu.equipment.commons.core;
...
public class Messages {
    ...
    public static final String MESSAGE_EQUIPMENTS_LISTED_OVERVIEW = "%1$d equipment listed!";
    public static final String MESSAGE_EQUIPMENT_DISPLAYED_OVERVIEW = "Equipment showed on map!";
