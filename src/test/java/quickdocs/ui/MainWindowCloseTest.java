...
public class MainWindowCloseTest extends GuiUnitTest {
    ...
    public void setUp() throws Exception {
        ...
        JsonQuickDocsStorage jsonQuickDocsStorage = new JsonQuickDocsStorage(temporaryFolder.newFile().toPath());
        StorageManager storageManager = new StorageManager(jsonUserPrefsStorage, jsonQuickDocsStorage);
