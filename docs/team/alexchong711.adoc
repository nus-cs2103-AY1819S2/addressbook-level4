...
The guide will include how users can use the application to manage their CAP and workload expectations while planning for the modules to take._
|===
...
The guide will include sequence diagrams about how the `cklimit`, `cursem`, and `setlimit` commands interact with the system, as well as class diagrams that describe the architecture of the system._
|===
