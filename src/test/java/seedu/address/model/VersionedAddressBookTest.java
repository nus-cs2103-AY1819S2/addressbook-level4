...
public class VersionedAddressBookTest {
    ...
    private final ReadOnlyAddressBook addressBookWithAmy = new AddressBookBuilder()
            .withPerson(DEFAULT_MODULE_CS2103T).build();
    private final ReadOnlyAddressBook addressBookWithBob = new AddressBookBuilder()
