...
My role in BrainTrain is to design and manage the quiz mode. The following sections will give a
summary of how I have contributed to the project and showcases my ability to write both the user and
developer guide.
...
which are only available in quiz mode and takes in all other inputs as answer.
