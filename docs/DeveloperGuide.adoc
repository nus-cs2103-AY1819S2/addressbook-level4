...
==== Architecture diagram for user storage
Below is a sketch diagram of how a file is parsed into BrainTrain

.File flow on start of BrainTrain Application
image::CsvUserDiagram.png[width="800"]
