...
I chose Alternative 1 because it offers a better user experience to just type in a few characters instead of having the
...
I chose Alternative 1 because there are not much categories a restaurant can have. Furthermore, if there ever arise a need
