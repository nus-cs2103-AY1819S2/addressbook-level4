...
* **`addTables`**`1 2 3` : adds 3 tables of size1, 2 and 3 respectively in the restaurant.
...
=== Listing all tables in the restaurant : `listTables`

Shows a list of all tables in the restaurant as well as their current occupancy. +
Format: `listTables`
