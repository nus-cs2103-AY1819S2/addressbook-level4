...
=== Advanced Operations
All the above operations described above focuses on how individual users may use the app, but this section
describes also how you can use it more effectively; creating multiple flashcards even faster and sharing it
with your friends.

The following `Import` and `Export` operations describe how you can do just that.
