...
public class StatusBarFooterTest extends GuiUnitTest {
    ...
    @Before
    public void setUp() {
        StatusBarFooter statusBarFooter = new StatusBarFooter(STUB_SAVE_LOCATION, foodDiary);
    ...
    public void display() {
        ...
        // after food diary is updated
        guiRobot.interact(() -> foodDiary.addRestaurant(ALICE));
