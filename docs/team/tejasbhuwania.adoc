...
This section contains an extract from the User Guide that shows how I guided the users regarding how to use the
`generate-bill` commands.
...
include::../DeveloperGuide.adoc[tag=user-stories2]
...
Updated the Ui Component Diagram to make it represent the current stage of Ui.
...
Updated the Storage Component Diagram to make it represent the current stage of Storage.
...
* Learnt how to work on a large code base with more 8000 lines of code.
* Learnt how to effectively work in a team when everyone is working on the same project.
