...
The type of the `AttackResult` returned can be seen from the following table:

[width="77%",cols="22%,<55%",options="header",]
|=======================================================================
...
The player does battle by using the `begin` command to initiate the battle,
then the `attack` command to attack the enemy.

The following sequence diagram shows what happens when the user enters the `begin` command is as follows:

.Sequence diagram of beginning the battle.
image::BeginSequenceDiagram.png[width=800]

The following sequence diagram shows what happens when the user enters the `attack a1` command is as follows:
