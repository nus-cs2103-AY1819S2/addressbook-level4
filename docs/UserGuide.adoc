...
* `find c/CS2` +
Lists all level-2000 CS modules in GradTrak.
* `find c/CS s/Y1S2` +
Lists all CS modules in Y1S2 in GradTrak.
...
Recommends a list of modules that can be taken based on GradTrak modules and course requirements.
Modules are displayed in order of requirement satisfied: Core, Programme/Technical Electives or Focus Area, Industry Experience, Faculty, General Education, Unrestricted Electives. +
Format: `rec`
