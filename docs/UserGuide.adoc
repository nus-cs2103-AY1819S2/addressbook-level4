...
image::study_ug_diagrams/study_1.png

The following image is the result of the command.

image::study_ug_diagrams/study_2.png
...
image::study_ug_diagrams/study_3.png

Submitting this reveals the next question.
image::study_ug_diagrams/study_4.png
...
|`select INDEX` | Selects the deck at INDEX.
...
|`done` | Returning to deck view after studying.
