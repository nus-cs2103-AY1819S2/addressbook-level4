...
*** Wrote the command summary in the user guide
...
'''
* Black/White and Brightness features
* Save Preset feature
* Command Summary
...
=== *Other Works Contributed*
'''
* Brightness and Black/White features under the Image Filter section
* Save Preset feature
