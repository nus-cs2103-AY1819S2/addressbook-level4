...
public class PrescriptionBuilder {
    ...
    public static final String DEFAULT_MEDICINE_NAME = "Aspirin";
    public static final String DEFAULT_DESCRIPTION = "For curing fever";
    ...
    public PrescriptionBuilder() {
        ...
        medicine = new Medicine(DEFAULT_MEDICINE_NAME);
