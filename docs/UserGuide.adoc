...
{bl}
[blue]#Welcome to the _In-Credit-Ble_ User Guide!# _In-Credit-Ble_ is a desktop application that you can use to track your
personal finances. Our user-friendly interface will make it easy for you to see how much you can safely spend within your
budget and be more aware of your spending habits. _In-Credit-Ble_ provides you with features such as having a budget bar
to show how much you have spent compared to a budget that you have previously set, and showing of a summary of your
transactions in a pie chart. If you are an university student who finds it hard to keep track of all your many transactions,
_In-Credit-Ble_ is the application just for you!
...
.Examples of `[fuchsia]#sort#` command in the default ordering. The records are sorted by name, amount, date and category respectively.
...
* Adding more entries while in the summary view mode will update the pie chart statistics automatically, as long as the
expense falls within the specified report period.
