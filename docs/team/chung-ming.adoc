...
****
_Given below is the start of extract of sections I contributed to the link:{websiteURL}/UserGuide.html[User Guide]. They showcase my ability to write documentation targeting end-users._
****
...
****
_This is the end of extract of the link:{websiteURL}/UserGuide.html[User Guide]._
****

== Contributions to the Developer Guide

****
_Given below is the start of extract of sections I contributed to the link:{websiteURL}/DeveloperGuide.html[Developer Guide]. They showcase my ability to write documentation targeting end-users._
****
...
****
_This is the end of extract of the link:{websiteURL}/DeveloperGuide.html[Developer Guide]._
****
