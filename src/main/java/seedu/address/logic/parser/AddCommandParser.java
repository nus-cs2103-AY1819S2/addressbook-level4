 ...
 */
public class AddCommandParser implements Parser<AddEquipmentCommand> {
    ...
    public AddEquipmentCommand parse(String args) throws ParseException {
        ...
        if (!arePrefixesPresent(argMultimap, PREFIX_NAME, PREFIX_ADDRESS, PREFIX_PHONE, PREFIX_EMAIL)
            ...
            throw new ParseException(String.format(MESSAGE_INVALID_COMMAND_FORMAT, AddEquipmentCommand.MESSAGE_USAGE));
        }
        ...
        Equipment equipment = new Equipment(name, phone, email, address, tagList);
