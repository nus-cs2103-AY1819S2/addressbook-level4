...
* know if any semesters have modules that have too many difficult modules that would pull down their cap unexpectedly, or too many easy modules that could be distributed to other semesters to maintain and more steady and predictable CAP for all semesters.
...
Figure 2000000000000000000000. Results of `cklimit` is displayed
...
* know how many hours of workload their current module plan has for each semester in total.
...
The image below shows the display after using the `cklimit` command and scrolling down the result page to the workload information:

image::CheckLimitScrolledDownDisplay.png[width="1000"]
Figure 2000000000000000000001. Results of `cklimit` is displayed after scrolling down the result page
...
* Given semester must be a valid semester from year 1 to 5, in either the first or second semester.
