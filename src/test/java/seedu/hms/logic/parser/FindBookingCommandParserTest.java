...
//        BookingContainsPayerPredicate bookingContainsPayerPredicate = new BookingContainsPayerPredicate("1231212A");
//        BookingWithinTimePredicate bookingWithinTimePredicate = new BookingWithinTimePredicate(new TimeRange(14, 16));
//        BookingWithTypePredicate bookingWithTypePredicate = new BookingWithTypePredicate("GYM");
//        FindBookingCommand expectedFindBookingCommand =
//            new FindBookingCommand(bookingContainsPayerPredicate,
//                bookingWithTypePredicate, bookingWithinTimePredicate);
//        assertParseSuccess(parser, " id/1231212A " + "s/GYM " + ":/14-16", expectedFindBookingCommand);
//
//        // multiple whitespaces between keywords
//        assertParseSuccess(parser, " \n Alice \n \t Bob  \t", expectedFindBookingCommand);
//    }
//
//}
