...
image:BattleshipHeadExample.png[width=800, height=300]
====
...
These methods check both the horizontal and vertical boundaries when a ship is being deployed. They also distinguish between the head and body of a ship in order to provide more specific feedback for the user.
