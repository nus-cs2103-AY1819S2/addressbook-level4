...
My additions to the user guide, which includes querying the statistics, setting the consultaton fee, the FAQ, and the
Command Summary. Shown below are the section for querying the statistics and setting the consultation fee._
|===
