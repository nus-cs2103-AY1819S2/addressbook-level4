...
/**
 * Selects a place identified using it's displayed index from the address book.
 */
public class SelectCommand extends Command {
    ...
    public static final String MESSAGE_SELECT_PERSON_SUCCESS = "Selected Place: %1$s";
