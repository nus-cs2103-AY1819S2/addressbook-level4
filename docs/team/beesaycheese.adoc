...
. *Major enhancements:* I add *_Statistics feature_* and it relevant commands.

.. *Calling for bill*: `bill` command
** What it does: It allows users to calculate and record the total bill accumulated from the table's orders.
