...
public class SampleDataUtil {
    public static Equipment[] getSamplePersons() {
        return new Equipment[] {
            new Equipment(new Name("Kaki Bukit CC"), new Phone("64454223"), new Date("21-05-2019"),
                    new Address("670 Bedok North Street 3, Singapore 469627"), new SerialNumber("X14H702695"),
                    getTagSet("east")),
            new Equipment(new Name("Hougang CC"), new Phone("63662218"), new Date("22-06-2019"),
                    new Address("35 Hougang Ave 3, Singapore 538840"), new SerialNumber("X14H702664"),
                    getTagSet("ongoing", "east")),
            new Equipment(new Name("Woodlands Galaxy CC"), new Phone("63662218"), new Date("23-05-2019"),
            ...
            new Equipment(new Name("Woodlands Community Center Singapore"), new Phone("63689938"),
                    new Date("27-09-2019"), new Address("1 Woodlands Street 81, Singapore 738526"),
                    new SerialNumber("X14H702672"), getTagSet("east")),
            new Equipment(new Name("Tampines North CC"), new Phone("67832900"), new Date("18-07-2019"),
                    new Address("2 Tampines Street 41, Singapore 529204"), new SerialNumber("X14H702901"),
                    getTagSet("closed")),
            new Equipment(new Name("Paya Lebar Kovan CC"), new Phone("62844261"), new Date("16-12-2019"),
