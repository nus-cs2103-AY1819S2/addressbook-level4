...
The `init` command can be used at any point in time during gameplay. When used in the middle of a game, the `init` command will act like a "new game" function and will reset the board to a clean state.
