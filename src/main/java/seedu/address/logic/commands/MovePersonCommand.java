...
public class MovePersonCommand extends Command {
    ...
    public boolean equals(Object other) {
        return other == this // short circuit if same object
                ...
                && to.equals(((MovePersonCommand) other).to)
                && from.equals(((MovePersonCommand) other).from)
                && indexes.equals(((MovePersonCommand) other).indexes)
                && (toAdd == null || toAdd.equals(((MovePersonCommand) other).toAdd)));
    }
}
