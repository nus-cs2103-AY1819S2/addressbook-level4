...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + RACE_DESC_BOB + SCHOOL_DESC_AMY + SCHOOL_DESC_BOB + MAJOR_DESC_BOB + PASTJOB_DESC_PROFESSOR
                + TAG_DESC_FRIEND, new AddCommand(expectedPerson));

        //multiple majors - last major accepted
        assertParseSuccess(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + RACE_DESC_BOB + SCHOOL_DESC_BOB + MAJOR_DESC_AMY + MAJOR_DESC_BOB + PASTJOB_DESC_PROFESSOR
                + TAG_DESC_FRIEND, new AddCommand(expectedPerson));

        //multiple race - last race accepted
        assertParseSuccess(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + RACE_DESC_BOB + SCHOOL_DESC_BOB + MAJOR_DESC_AMY + RACE_DESC_AMY + PASTJOB_DESC_PROFESSOR
                + TAG_DESC_FRIEND, new AddCommand(expectedPerson));
        ...
        Person expectedPersonMultipleTags = new PersonBuilder(BOB)
            ...
            .build();
        assertParseSuccess(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + RACE_DESC_BOB + SCHOOL_DESC_BOB + MAJOR_DESC_BOB
    ...
    public void parse_optionalFieldsMissing_success() {
        ...
        assertParseSuccess(parser, NAME_DESC_AMY + PHONE_DESC_AMY + EMAIL_DESC_AMY + ADDRESS_DESC_AMY
                + RACE_DESC_AMY + SCHOOL_DESC_AMY + MAJOR_DESC_AMY + PASTJOB_DESC_PROFESSOR,
    ...
    public void parse_compulsoryFieldMissing_failure() {
        ...
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + VALID_ADDRESS_BOB
                + RACE_DESC_BOB + VALID_SCHOOL_BOB + MAJOR_DESC_BOB,
                expectedMessage);

        // missing major prefix
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + VALID_ADDRESS_BOB
                + RACE_DESC_BOB + SCHOOL_DESC_BOB + VALID_MAJOR_BOB,
                expectedMessage);

        // missing race prefix
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + VALID_ADDRESS_BOB
                + VALID_RACE_BOB + SCHOOL_DESC_BOB + MAJOR_DESC_BOB,
                expectedMessage);
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, INVALID_NAME_DESC + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + SCHOOL_DESC_BOB + MAJOR_DESC_BOB + RACE_DESC_BOB
        ...
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + INVALID_SCHOOL_DESC + MAJOR_DESC_BOB + RACE_DESC_BOB
                + TAG_DESC_HUSBAND + TAG_DESC_FRIEND, School.MESSAGE_CONSTRAINTS);

        // invalid major
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + SCHOOL_DESC_BOB + INVALID_MAJOR_DESC + RACE_DESC_BOB
                + TAG_DESC_HUSBAND + TAG_DESC_FRIEND, Major.MESSAGE_CONSTRAINTS);

        // invalid race
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + SCHOOL_DESC_BOB + INVALID_MAJOR_DESC + INVALID_RACE_DESC
