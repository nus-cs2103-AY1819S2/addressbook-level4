...
public class JsonAdaptedRestaurantTest {
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedRestaurant restaurant = new JsonAdaptedRestaurant(INVALID_NAME, VALID_PHONE, VALID_EMAIL,
                VALID_ADDRESS, VALID_TAGS, VALID_CUISINE, VALID_WEBLINK, VALID_OPENING_HOURS);
    ...
    public void toModelType_invalidAddress_throwsIllegalValueException() {
        JsonAdaptedRestaurant restaurant = new JsonAdaptedRestaurant(VALID_NAME, VALID_PHONE, VALID_EMAIL,
                INVALID_ADDRESS, VALID_TAGS, VALID_CUISINE, VALID_WEBLINK, VALID_OPENING_HOURS);
    ...
    public void toModelType_nullAddress_throwsIllegalValueException() {
        JsonAdaptedRestaurant restaurant = new JsonAdaptedRestaurant(VALID_NAME, VALID_PHONE, VALID_EMAIL,
                null, VALID_TAGS, VALID_CUISINE, VALID_WEBLINK, VALID_OPENING_HOURS);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedRestaurant restaurant = new JsonAdaptedRestaurant(VALID_NAME, VALID_PHONE, VALID_EMAIL,
                VALID_ADDRESS, invalidTags, VALID_CUISINE, VALID_WEBLINK, VALID_OPENING_HOURS);
    ...
    public void toModelType_invalidCuisine_throwsIllegalValueException() {
        JsonAdaptedRestaurant restaurant = new JsonAdaptedRestaurant(VALID_NAME, VALID_PHONE, VALID_EMAIL,
                VALID_ADDRESS, VALID_TAGS, INVALID_CUISINE, VALID_WEBLINK, VALID_OPENING_HOURS);
