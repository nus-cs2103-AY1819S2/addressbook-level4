...
public class DeleteCommandSystemTest extends AddressBookSystemTest {
    ...
    public void delete() {
        ...
        /* Case: filtered medicine list, delete index within bounds of address book and medicine list -> deleted */
        ...
        /* Case: filtered medicine list, delete index within bounds of address book but out of bounds of medicine list
         * -> rejected
         */
        showMedicinesWithName(KEYWORD_MATCHING_MEIER);
        ...
        Index outOfBoundsIndex = Index.fromOneBased(
                getModel().getAddressBook().getMedicineList().size() + 1);
    ...
    /**
     * Removes the {@code Medicine} at the specified {@code index} in {@code model}'s address book.
