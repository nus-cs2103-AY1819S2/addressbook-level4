...
(https://github.com/CS2103-AY1819S2-W14-1/main/pull/175[#175])
*** Implemented `ChangeThemeCommand` to change between light and dark theme that persists beyond
app restart. (https://github.com/CS2103-AY1819S2-W14-1/main/pull/175[#175])
*** Updated BrainTrain icon (https://github.com/CS2103-AY1819S2-W14-1/main/pull/96[#175])
