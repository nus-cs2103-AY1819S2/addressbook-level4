...
The third view, `studyView`, is implemented to facilitate study sessions.

A study session is a state in the program that allows users to test their knowledge
by presenting them with Cards in the Deck.

The program alternates
between presenting users with questions and then showing answers to these questions.

There are two cycles in this
...
The study mechanism is facilitated by `ModelManager`.
