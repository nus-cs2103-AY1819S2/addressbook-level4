...
image::Statistics_ModelClassDiagramAnnotated.png[width="700"]
...
history which will provide the necessary functions it will need to execute the command prpoperly with the following
operations:
