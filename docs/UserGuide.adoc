...
Step 1: List all the restaurants by typing `list`, then pressing enter.
...
Step 4: Key in the price range next.
...
Step 5: Press enter and the categories will be set! Else, you might have made a typo somewhere.
