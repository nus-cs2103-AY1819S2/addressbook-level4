...
public class JsonAdaptedCardTest {
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedCard card =
                new JsonAdaptedCard(INVALID_QUESTION, VALID_ANSWER, VALID_EMAIL, VALID_ADDRESS, VALID_HINT);
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        JsonAdaptedCard card = new JsonAdaptedCard(null, VALID_ANSWER, VALID_EMAIL, VALID_ADDRESS, VALID_HINT);
    ...
    public void toModelType_invalidAnswer_throwsIllegalValueException() {
        JsonAdaptedCard card =
                new JsonAdaptedCard(VALID_QUESTION, INVALID_ANSWER, VALID_EMAIL, VALID_ADDRESS, VALID_HINT);
    ...
    public void toModelType_nullAnswer_throwsIllegalValueException() {
        JsonAdaptedCard card = new JsonAdaptedCard(VALID_QUESTION, null, VALID_EMAIL, VALID_ADDRESS, VALID_HINT);
    ...
    public void toModelType_invalidEmail_throwsIllegalValueException() {
        JsonAdaptedCard card =
                new JsonAdaptedCard(VALID_QUESTION, VALID_ANSWER, INVALID_EMAIL, VALID_ADDRESS, VALID_HINT);
    ...
    public void toModelType_nullEmail_throwsIllegalValueException() {
        JsonAdaptedCard card = new JsonAdaptedCard(VALID_QUESTION, VALID_ANSWER, null, VALID_ADDRESS, VALID_HINT);
    ...
    public void toModelType_invalidAddress_throwsIllegalValueException() {
        JsonAdaptedCard card =
                new JsonAdaptedCard(VALID_QUESTION, VALID_ANSWER, VALID_EMAIL, INVALID_ADDRESS, VALID_HINT);
    ...
    public void toModelType_nullAddress_throwsIllegalValueException() {
        JsonAdaptedCard card = new JsonAdaptedCard(VALID_QUESTION, VALID_ANSWER, VALID_EMAIL, null, VALID_HINT);
    ...
    public void toModelType_invalidHint_throwsIllegalValueException() {
        ...
        JsonAdaptedCard card =
                new JsonAdaptedCard(VALID_QUESTION, VALID_ANSWER, VALID_EMAIL, VALID_ADDRESS, invalidHint);
