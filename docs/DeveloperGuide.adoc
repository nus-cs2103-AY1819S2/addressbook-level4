...
Step 2. The user calls `listUnvisited po/267951`. The `listUnvisitedCommand` class will be initialised. A new `SortBy` will be created by the 'listUnvisitedCommand` class containing the `PostalData` of '267951'.
