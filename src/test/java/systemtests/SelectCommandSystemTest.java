...
public class SelectCommandSystemTest extends GradTrakSystemTest {
    @Test
    public void select() {
        /* ------------------------ Perform select operations on the shown unfiltered list -------------------------- */

        /* Case: select the first card in the moduleTaken list, command with leading spaces and trailing spaces
         * -> selected
         */
        String command = "   " + SelectCommand.COMMAND_WORD + " " + INDEX_FIRST_PERSON.getOneBased() + "   ";
        assertCommandSuccess(command, INDEX_FIRST_PERSON);

        /* Case: select the last card in the moduleTaken list -> selected */
        ...
        /* Case: select the middle card in the moduleTaken list -> selected */
        ...
        /* Case: filtered moduleTaken list, select index within bounds of address book but out of bounds of
        ...
        assertCommandFailure(SelectCommand.COMMAND_WORD + " " + invalidIndex,
                MESSAGE_INVALID_MODULETAKEN_DISPLAYED_INDEX);
     ...
     * {@code expectedSelectedCardIndex} of the selected moduleTaken.<br>
