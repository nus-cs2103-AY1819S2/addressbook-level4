...
Figure 3.8.1 shows the sequence diagram for the different method invocation calls between the classes.
// end::setreminder[]
...
Figure 3.10.1 shows the state machine diagram for the `AutoCompleteTextField` behaviour when it listens for a user input.
