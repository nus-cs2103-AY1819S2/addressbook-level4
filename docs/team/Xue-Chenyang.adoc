...
[NOTE]
Click https://github.com/CS2103-AY1819S2-W09-4/main/blob/master/docs/UserGuide.adoc[here] to see the full User Guide.

== Contribution to the Developer Guide

|===
|_In this section, I will showcase a sample section of Developer Guide I contributed._ +
_The sample sections explains the implementations of medicine modules and auto-completion features.
|===
