...
public class EditCommandTest {
    ...
    public void execute_allFieldsSpecifiedUnfilteredList_success() {
        ...
        assertCommandSuccess(editCommand, model, commandHistory, expectedMessage, expectedModel, currentEdit, album);
    }
    ...
    public void execute_duplicatePersonUnfilteredList_failure() {
        ...
        assertCommandFailure(editCommand, model, commandHistory, EditCommand.MESSAGE_DUPLICATE_PERSON, currentEdit,
            album);
    }
    ...
    public void executeUndoRedo_validIndexUnfilteredList_success() throws Exception {
        ...
        editCommand.execute(currentEdit, album, model, commandHistory);
