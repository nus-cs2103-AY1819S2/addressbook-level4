...
If you would like to get started straightaway,  jump to the <<Quick Start>> to get started
...
FD also stores your data locally, ensuring that your privacy is protected.
