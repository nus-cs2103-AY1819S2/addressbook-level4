...
[NOTE]
When the same prefix is typed more than once, only the last prefix is accepted.

[NOTE]
See the full list of three-letter ISO-3166 Country Codes, here link:CountryCodes.html[CountryCodes]
