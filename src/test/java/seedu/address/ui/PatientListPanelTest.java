...
public class PatientListPanelTest extends GuiUnitTest {
    private static final ObservableList<Patient> TYPICAL_PERSONS =
    ...
    public void display() {
        ...
        for (int i = 0; i < TYPICAL_PERSONS.size(); i++) {
            patientListPanelHandle.navigateToCard(TYPICAL_PERSONS.get(i));
            Patient expectedPatient = TYPICAL_PERSONS.get(i);
    ...
    public void selection_modelSelectedPatientChanged_selectionChanges() {
        initUi(TYPICAL_PERSONS);
        Patient secondPatient = TYPICAL_PERSONS.get(INDEX_SECOND_PERSON.getZeroBased());
...
/**
    ...
    private ObservableList<Patient> createBackingList(int patientCount) {
        ...
        for (int i = 0; i < patientCount; i++) {
            ...
            Patient patient = new Patient(name, gender, age, phone, address, Collections.emptySet());
