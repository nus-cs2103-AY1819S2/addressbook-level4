...
import seedu.equipment.commons.core.Version;
import seedu.equipment.commons.exceptions.DataConversionException;
import seedu.equipment.commons.util.ConfigUtil;
...
import seedu.equipment.storage.EquipmentManagerStorage;
...
public class MainApp extends Application {
    ...
    public void init() throws Exception {
        ...
        EquipmentManagerStorage equipmentManagerStorage = new JsonEquipmentManagerStorage(
                userPrefs.getEquipmentManagerFilePath());
    ...
    /**
     * Returns a {@code ModelManager} with the data from {@code storage}'s equipment book and {@code userPrefs}. <br>
     * The data from the sample equipment book will be used instead if {@code storage}'s equipment book is not found,
