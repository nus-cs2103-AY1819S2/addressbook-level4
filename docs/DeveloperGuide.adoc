...
[discrete]
=== Use case: Put equipment

*MSS*

1.  User requests to list WorkList
2.  Equipment shows a list of WorkList
3.  User requests to put a specific equipment into a specified WorkList
4.  *Equipment Manager* puts the equipment into that WorkList
+
Use case ends.
...
* 3a. The specified equipment is not found.
+
Use case ends.

* 3b. The specified WorkList is not found.
+
Use case ends.
