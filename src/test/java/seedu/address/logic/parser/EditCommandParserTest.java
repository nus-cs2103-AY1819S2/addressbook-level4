...
public class EditCommandParserTest {
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, "1" + INVALID_DESCRIPTION, Description.MESSAGE_CONSTRAINTS); // invalid description
        ...
        assertParseFailure(parser, "1" + INVALID_NAME_DESC + INVALID_DESCRIPTION + VALID_ADDRESS_AMY + VALID_PHONE_AMY,
    ...
    public void parse_someFieldsSpecified_success() {
        ...
        EditPlaceDescriptor descriptor = new EditPlaceDescriptorBuilder().withPhone(VALID_PHONE_BOB)
    ...
    public void parse_invalidValueFollowedByValidValue_success() {
        ...
        EditPlaceDescriptor descriptor = new EditPlaceDescriptorBuilder().withPhone(VALID_PHONE_BOB).build();
        EditCommand expectedCommand = new EditCommand(targetIndex, descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);
        ...
        userInput = targetIndex.getOneBased() + DESCRIPTION_BOB + INVALID_PHONE_DESC + ADDRESS_DESC_BOB
                + PHONE_DESC_BOB;
        descriptor = new EditPlaceDescriptorBuilder().withPhone(VALID_PHONE_BOB).withDescription(VALID_DESCRIPTION_BOB)
