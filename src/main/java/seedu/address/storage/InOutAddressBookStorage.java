...
import seedu.address.commons.util.PdfUtil;
...
public class InOutAddressBookStorage implements AddressBookStorage {
    ...
    public void saveAsPdf(ReadOnlyAddressBook addressBook, Path filePath) throws IOException {
        ...
        PdfUtil.savePdfFile(new PdfSerializableAddressBook(addressBook).getPersons(),
                            new PdfSerializableAddressBook(addressBook).getTasks(), filePath);
    }
}
