...
public class CommandTestUtil {
    ...
    public static final String VALID_DATE_OF_BIRTH_AMY = "28/05/1999";
    ...
    public static final String INVALID_DATE_OF_BIRTH_DESC = " " + PREFIX_DATE_OF_BIRTH + "2/5/2000"; //incorrect format
    ...
    static {
        DESC_AMY = new EditCustomerDescriptorBuilder().withName(VALID_NAME_AMY)
            .withPhone(VALID_PHONE_AMY).withDateOfBirth(VALID_DATE_OF_BIRTH_AMY).withEmail(VALID_EMAIL_AMY).withIdNum(VALID_ID_AMY)
            .withAddress(VALID_ADDRESS_AMY).withTags(VALID_TAG_FRIEND).build();
        DESC_BOB = new EditCustomerDescriptorBuilder().withName(VALID_NAME_BOB)
            .withPhone(VALID_PHONE_BOB).withDateOfBirth(VALID_DATE_OF_BIRTH_BOB).withEmail(VALID_EMAIL_BOB).withIdNum(VALID_ID_BOB)
