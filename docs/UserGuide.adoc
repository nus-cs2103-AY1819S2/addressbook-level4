...
You can easily edit any part of an existing entries in _In-Credit-Ble_. +
...
.Example of removing the description from a entries
...
[TIP]
Make use of the `list` command to show the full list of records again after filtering the records using the `search`
command.
