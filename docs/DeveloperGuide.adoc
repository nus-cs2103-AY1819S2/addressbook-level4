...
* Step 2: The `memberFilter` command will check if the filter category entered by the user is valid. Note that this is case-insensitive.
* Step 3: The `memberFilter` command will then call the Model
...
* Step 2: The `memberList` command will then call the Model
