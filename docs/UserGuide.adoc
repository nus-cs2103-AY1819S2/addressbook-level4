...
Shows a list of all the player's battleships that are have been deployed on the map. There are two ways of using the `list` command: (1) to list all the battleships and (2) to list all the battleships that match a list of tags.
