...
Adds a battleship onto your map. The coordinates specified is the position of the ship's head. +
...
Shows a list of all of your battleships that have been deployed on the map. There are four ways of using the `list` command:
