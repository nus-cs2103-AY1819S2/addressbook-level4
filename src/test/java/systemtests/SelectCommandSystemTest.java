...
public class SelectCommandSystemTest extends CardFolderSystemTest {
    ...
    public void select() {
        ...
        /* Case: filtered person list, select index within bounds of card folder but out of bounds of person list
         * -> rejected
         */
        ...
        /* Case: filtered person list, select index within bounds of card folder and person list -> selected */
