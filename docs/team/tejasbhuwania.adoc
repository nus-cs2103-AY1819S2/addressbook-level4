...
* *Minor enhancements*:
** https://github.com/cs2103-ay1819s2-t12-1/main/blob/master/docs/UserGuide.adoc#33-customer-commands[Added support for VIP status to customer]
** https://github.com/cs2103-ay1819s2-t12-1/main/blob/master/docs/UserGuide.adoc#332-listing-all-customers--list-customers-lc[Ported the whole codebase from `AddressBook` to `HotelManagementSystem`]
...
*** https://github.com/cs2103-ay1819s2-t12-1/main/blob/master/docs/DeveloperGuide.adoc#32-ui-component[Reviewed and approves several PRs.]
