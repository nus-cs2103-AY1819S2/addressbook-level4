...
as part of a Software Engineering module (CS2103T). As part of the module requirement,
 ...
 span of 13 weeks while learning new software engineering concepts. We have opted for the option
 of morphing the existing application into another (from an Address Book to a Finance Tracker).
 In this project portfolio, I will be documenting my contributions to this project through the major
