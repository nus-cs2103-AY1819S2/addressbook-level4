...
import static seedu.address.logic.parser.CliSyntax.PREFIX_SERIALNUMBER;
...
public class CommandTestUtil {
    ...
    public static final String VALID_SERIAL_NUMBER_AMY = "A087766C";
     ...
     * - the address book, filtered equipment list and selected equipment in {@code actualModel} remain unchanged <br>
    ...
    /**
     * Deletes the first equipment in {@code model}'s filtered list from {@code model}'s address book.
     */
