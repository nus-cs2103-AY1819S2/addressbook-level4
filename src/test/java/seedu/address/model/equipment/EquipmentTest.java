...
public class EquipmentTest {
    ...
    public void isSamePerson() {
        ...
        Equipment editedAlice = new PersonBuilder(ALICE).withPhone(VALID_PHONE_BOB).withEmail(VALID_EMAIL_BOB).build();
    ...
    public void equals() {
        ...
        Equipment aliceCopy = new PersonBuilder(ALICE).build();
        ...
        // different name -> returns false
        Equipment editedAlice = new PersonBuilder(ALICE).withName(VALID_NAME_BOB).build();
