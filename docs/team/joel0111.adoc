...
*** *Lists* all of the members in Club Manager (`memberList`).
*** *Filters* the list of members based on a given filter criteria. This allows the user to shortlist members for activities (e.g. competition) based on a particular member's attribute (`memberFilter`).
...
* Provided UI Walkthrough in the User Guide.
