...
* *Enhancement 2*: added the ability to *sort the equipment list according to specified keywords*
** What it does: The `sort` command allows the user to sort the equipment list by the given keywords:
*** Name
*** Date
*** Serial Number
*** Phone
...
*** If users were to forget what are the keywords available, error messages would guide them to execute the commands correctly.
