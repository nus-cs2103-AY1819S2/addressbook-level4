...
|`* *` |CCA main committee member |see who are in this CCA |see the new members in the list
...
.  Should have a short but concise user tutorial section to speed up new users’ assimilation of the system.
.  Available offline to ensure system can be used at all times.
