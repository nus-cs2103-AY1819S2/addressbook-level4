...
public class FinanceTrackerParserTest {
    ...
    public void parseCommand_search() throws Exception {
        ...
        SearchCommand command = (SearchCommand) parser.parseCommand(
                SearchCommand.COMMAND_WORD + " " + COMMAND_FLAG_NAME + " " + keywords.stream().collect(Collectors.joining(" ")));
    ...
    public void parseCommand_searchAlias() throws Exception {
        List<String> keywords = Arrays.asList("foo", "bar", "baz");
        SearchCommand command = (SearchCommand) parser.parseCommand(
                SearchCommand.COMMAND_ALIAS + " " + COMMAND_FLAG_NAME + " " + keywords.stream().collect(Collectors.joining(" ")));
        assertEquals(new SearchCommand(new NameContainsKeywordsPredicate(keywords)), command);
    }
