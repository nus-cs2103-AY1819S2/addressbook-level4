...
* Team-wide contributions: I contributed to the overall project by,
...
** Assisting fellow developer <<halcyoneee#, Tze Ting>> on designing the app's light and dark themes (see link:{pullURL}180[#180])
...
include::../UserGuide.adoc[tag=evan-intro]

{empty} +

=== Excerpt: Quick start
include::../UserGuide.adoc[tag=evan-start]
