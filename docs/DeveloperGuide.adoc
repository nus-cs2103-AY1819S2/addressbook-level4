...
|`* * *` |Food lover |Categorise restaurants by cuisine |Filter restaurants of different cuisines later on

|`* * *` |Food lover |Categorise restaurants by suitable occasion |Easily refer back for suitable dining options during special occasions
