...
image::RemoveDescriptionExample.png[width ="900"]
...
[TIP]
Make use of the `list` command to reset the records after you filter the records using the `search` command.
...
image::SearchByCategoryExample.png[width ="900"]
...
image::TotalSpentInResultDisplay.png[width ="900"]
