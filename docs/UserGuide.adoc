...
* `list-customers`, then `ar r/SINGLE ROOM d/20/05/2019 - 25/05/2019 $/1` +
Adds a reservation of Single Room in the name of the 1st customer from 20 May 2019 to 25 May 2019.
* `find-name Jack Rose`, then `add-reservation r/DELUXE ROOM d/14/06/2019-15/06/2019 $/1 c/2` +
Adds a reservation of Deluxe Room, in the name of the first customer for both him/her and the second customer, from 14 June 2019 to 15 June 2019.
