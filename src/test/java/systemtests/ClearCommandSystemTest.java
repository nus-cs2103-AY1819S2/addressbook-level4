...
public class ClearCommandSystemTest extends MediTabsSystemTest {
    ...
    public void clear() {
        ...
        /* Case: selects first card in medicine list and clears inventory -> cleared and no card selected */
