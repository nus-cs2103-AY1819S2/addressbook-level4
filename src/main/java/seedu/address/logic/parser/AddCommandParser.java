    ...
    public AddCommand parse(String args) throws ParseException {
        ArgumentMultimap argMultimap =
                ArgumentTokenizer.tokenize(
                        args, PREFIX_QUESTION, PREFIX_ANSWER, PREFIX_ADDRESS, PREFIX_HINT);

        if (!arePrefixesPresent(argMultimap, PREFIX_QUESTION, PREFIX_ADDRESS, PREFIX_ANSWER)
        ...
        Card card = new Card(question, answer, address, score, hintList);
