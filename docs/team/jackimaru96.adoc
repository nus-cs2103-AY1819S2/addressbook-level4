...
[IMPORTANT]
====
This box will appear when there are important caution that you should take note of
====
****
...
[NOTE]
====
To allow users to start getting used to the application quickly, I've created the `Quick Start` and
...
to support my writing so that users can have visual aids to guide their understanding. Head over to the User
Guide to take a look at the Quick Start section
link:https://github.com/CS2103-AY1819S2-W17-3/main/blob/master/docs/UserGuide.adoc[here] and the GUI introduction is
given below.
====
...
This is important as in real-world software engineering projects where we are expected to work in team and being able to
document the Developer Guide well will allow colleagues or other developers to understand what we have coded better.
Due to page restrictions, I've only included the `allocate` feature which I've contributed to the Developer Guide. Other
sections which I contributed include the `show` command. +
