...
** Cons: Not logical for test to be called from home directory which should only allow folder operations. `test` command
will then have to implicitly enter the folder to get access to the cards in it in order to display them, creating a
