...
image::Record_List_Panel.png[width="250"]
...
image::BudgetPanel.png[width="300"]
...
image::BudgetPanel_Orange.png[width="300"]

.Budget progress bar turns red to give warning
image::BudgetPanel_red.png[width="300"]
...
image::browserpanel.png[width="300"]
...
.Command Box and Result Display
image::commandbox_resultdisplay.png[width="400"]
