...
=== Global Operations
The commands shown in this section are applicable regardless of whether the user is inside a folder, at the home
directory, inside a test or report session.
