...
public class Messages {
    ...
    public static final String MESSAGE_INVALID_CARD_DISPLAYED_INDEX = "The folder index provided is invalid";
    public static final String MESSAGE_INVALID_FOLDER_DISPLAYED_INDEX = "The folder folder index provided is invalid";
