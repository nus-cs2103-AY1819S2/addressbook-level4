...
public class SampleDataUtil {
    public static Customer[] getSampleCustomers() {
        return new Customer[] {
            new Customer(new Name("Al()ex Yeoh"), new Phone("87438807"), new DateOfBirth ("28/05/1999"), new Email("alexyeoh@example.com"),
                new IdentificationNo("987653"), new Address("Blk 30 Geylang Street 29, #06-40"),
                getTagSet("friends")),
            new Customer(new Name("Bernice Yu"), new Phone("99272758"), new DateOfBirth ("28/01/1999"), new Email("berniceyu@example.com"),
                new IdentificationNo("98764353"), new Address("Blk 30 Lorong 3 Serangoon Gardens, #07-18"),
                getTagSet("colleagues", "friends")),
            new Customer(new Name("Charlotte Oliveiro"), new Phone("93210283"), new DateOfBirth ("28/10/1999"), new Email("charlotte@example.com"),
