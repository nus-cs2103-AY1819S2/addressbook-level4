...
public class EditMedicineDescriptorTest {
    ...
    public void equals() {
        ...
        editedAmy = new EditMedicineDescriptorBuilder(DESC_AMY).withPhone(VALID_PHONE_BOB).build();
        assertFalse(DESC_AMY.equals(editedAmy));
        ...
        editedAmy = new EditMedicineDescriptorBuilder(DESC_AMY).withAddress(VALID_ADDRESS_BOB).build();
        assertFalse(DESC_AMY.equals(editedAmy));
