...
You can easily refer to the batch table provided in the information panel while updating and managing your inventory. Simply select a medicine using the <<SelectCommand>> to view all its relevant details.  

You can also sort the table by any of its columns with the <<SortCommand>> to suit your needs and preference. 
