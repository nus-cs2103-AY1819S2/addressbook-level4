...
public class AddressBookParserTest {
    ...
    public void parseCommand_edit() throws Exception {
        ...
        EditCommand command = (EditCommand) parser.parseCommand(EditCommand.COMMAND_WORD + " "
                + INDEX_FIRST_BUYER.getOneBased() + " " + PersonUtil.getEditPersonDescriptorDetails(descriptor));
    ...
    public void parseCommand_search() throws Exception {
        ...
        assertEquals(new SearchCommand(new PersonContainsKeywordsPredicate(keywords)), command);
    }
    ...
    public void parseCommand_select() throws Exception {
        SelectCommand command = (SelectCommand) parser.parseCommand(
                SelectCommand.COMMAND_WORD + " " + INDEX_FIRST_BUYER.getOneBased());
        assertEquals(new SelectCommand(INDEX_FIRST_BUYER), command);
    }
