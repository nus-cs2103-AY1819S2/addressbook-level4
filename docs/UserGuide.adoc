...
* Commands can only be input with Unicode characters compatible with XML. In general, most characters visible on your keyboard are supported!
...
**Resizable graph** `Coming in v2.0`
...
scroll bars to view the graph and questions. Hang tight, a display that changes in size is coming soon!
