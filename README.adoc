...
* This is a desktop patient management application designed for clinic receptionists. It has a GUI but most of the user interactions happen using a CLI (Command Line Interface).
