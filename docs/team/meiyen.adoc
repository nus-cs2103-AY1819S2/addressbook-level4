...
This Personal Project Portfolio details the contributions which I have made to the Equipment Manager project for CS2103T Software Engineering module. My main responsibilites are implementing command features and ensuring proper documentation.
...
* *Enhancement 1*: Implement filter feature to *filter the current shown list according to specified keywords*
...
* *Enhancement 2*: Implement sort feature to *sort the current shown list according to specified fields*
