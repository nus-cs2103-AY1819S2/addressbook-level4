...
public class StatusBarFooterTest extends GuiUnitTest {
    ...
    @Before
    public void setUp() {
        StatusBarFooter statusBarFooter = new StatusBarFooter(STUB_SAVE_LOCATION, travelBuddy);
    ...
    public void display() {
        ...
        // after travel book is updated
        guiRobot.interact(() -> travelBuddy.addPlace(ALICE));
