...
public class GuiTestAssert {
    ...
    public static void assertCardDisplaysRecord(Record expectedRecord, RecordCardHandle actualCard) {
        ...
        assertTagsEqual(expectedRecord, actualCard);
    }

    /**
     * Returns the color style for {@code tagName}'s label. The tag's color is determined by looking up the color
     * in {@code RecordCard#TAG_COLOR_STYLES}, using an index generated by the hash code of the tag's content.
     *
     *
     */
    ...
    /**
     * Asserts that the tags in {@code actualCard} matches all the tags in {@code expectedRecord} with the correct
     * color.
     */
    private static void assertTagsEqual(Record expectedRecord, RecordCardHandle actualCard) {
        List<String> expectedTags = expectedRecord.getTags().stream()
