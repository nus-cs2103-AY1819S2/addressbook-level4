...
When a user executes `search-p-status`,
...
. If the entered argument is valid, the command proceeds to execute. Otherwise, it will throw a ParseException and display the correct usage to the user.
