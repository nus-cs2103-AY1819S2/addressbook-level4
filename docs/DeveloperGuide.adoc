...
:sourceDir: https://cs2103-ay1819s2-w10-3.github.io/main
:xrefstyle: full
ifdef::env-github[]
:tip-caption: :bulb:
...
|`* * *` |new user |be able to understand the UI without much instructions |spend my time on the program features
...
|`*` |user |change command keywords |use words that I prefer
...
(For all use cases below, the *System* is the `Equipment Manager` and the *Actor* is the `user / engineer`, unless specified otherwise)
