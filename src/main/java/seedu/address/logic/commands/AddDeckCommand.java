...
public class AddDeckCommand extends Command {
    ...
    public static final String MESSAGE_USAGE = COMMAND_WORD + ": Create a new deck." + "Parameters: "
            + PREFIX_NAME + "NAME\n" + "Example: " + COMMAND_WORD + " " + PREFIX_NAME + "MyDeck";

    public static final String MESSAGE_SUCCESS = "Added deck: %1$s";
