...
.Component interactions for `attack a1` command
...
[source,java]
----
include::../src/main/java/seedu/address/model/player/Enemy.java[lines=85..105]
----
...
image::StatsWindowSS.png[width=350]
...
image::StatsWindowUpdatedSS.PNG[width=350]
...
image::StatsSequenceDiagram.PNG[width=600 ]
