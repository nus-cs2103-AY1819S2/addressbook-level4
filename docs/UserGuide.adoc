...
Example: `add c/seller n/James Lee p/98765432 e/jameslee@example.com r/need to sell by April 2018 a/Blk 345 Clementi Ave 5, #04-04, S120345 sp/500000 t/MRT t/newlyRenovated`
...
Example: `edit 2 n/James Tan e/jamestan@example.com r/looking for houses in Woodlands` +
