...
The following class diagram illustrates the relationship between the Model components in Statistics.

.Class diagram for Model components in Statistics feature
...
Hence, we did not see the need to store receipts in the storage and implemented Alternative 1.
...
We implemented Alternative 1 to prioritize efficiency in this use case. Since `bill` command is only
...
|=======================================================================
| Aspect | Alternative 1 | Alternative 2
| Arrangement of XXXStatisticsCard +
| XXXStatisticsCard are arranged in descending order.+
...
Statistical revenue data are stored in the
===== Current Implementation


.Revenue Activity Diagram
