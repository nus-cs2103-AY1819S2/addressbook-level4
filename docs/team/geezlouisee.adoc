...
** Project management:
*** Helped to manage issue tracker (https://github.com[#89], https://github.com[#105])
** Enhancements to existing features:
*** o	Added more colours to tags, and refactored them as categories to suit our product (https://github.com[#20], https://github.com[#59], https://github.com[#73])
** Documentation:
*** Did cosmetic tweaks to existing contents of the User Guide: https://github.com[#14]
*** Did cosmetic tweaks to the Developer Guide (https://github.com[#4], https://github.com[#8], https://github.com[#78])
** Community:
