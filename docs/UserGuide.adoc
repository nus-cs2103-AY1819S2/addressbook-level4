...
=== Features executable in RestaurantMode
...
****
* Command can only be used in Restaurant Mode.
...
=== Features executable in TableMode
...
****
* Command can only be used in Table Mode.
...
Calculates the bill of an order from the specified table in TableMode. +
Format: `bill`
...
=== Features executable in MenuMode
...
=== Features executable in StatisticsMode
