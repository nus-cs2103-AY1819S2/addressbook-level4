...
|===
|_Given below are sections I contributed to the Developer Guide, showing implementation I have made for the `session` feature. They showcase my ability to write technical documentation and the technical depth of my contributions to the project._
|===
