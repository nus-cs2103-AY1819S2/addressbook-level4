...
*API* : link:{repoURL}/src/main/java/seedu/address/Storage/ModuleInfoStorage.java[`ModuleInfoStorage.java`]
...
image::PrerequisiteStringFormat.png[width="800"]
...
During initial launch, after each module's information is converted into `ModuleInfo` objects, it will be added to a
