...
* `add-patient n/John Doe g/M a/21 p/98765432 adr/Utown College 2`
* `add-patient n/Betsy Crowe g/F p/8234567 a/32 adr/RVRC House 12 t/diabetic`
...
Format: `search-advanced [keyword] ["quoted_keyword"]...`
...
* *Add a new patient* `add-patient [n/NAME] [g/GENDER] [a/AGE] [p/PHONE_NUMBER] [adr/ADDRESS] [t/TAG]` +
* *List existing patients* : `list-patient`
* *Delete an existing patient* : `delete-patient [INDEX]` +
e.g. `delete-patient 3`
* *Edit an existing patient* : `edit-patient [INDEX] [n/NAME] [g/GENDER] [a/AGE] [p/PHONE] [adr/ADDRESS] [t/TAG]` +
* *Searching a patient by name* : `search-patient [NAME]` +
* *Searching a patient by tags* : `search-tag [TAG]` +
* *Searching a patient by pid* : `search-pid [pid]` +
* *Searching a patient (advanced)* : `search-advanced [KEYWORD] ["QUOTED_KEYWORD"]` +
