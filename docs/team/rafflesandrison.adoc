...
Within the Wardrobe Management Feature, you will find many commands implemented to manipulate the arrangement of the apparels. These include:
...
[[list]]
. *List apparels*: added *the ability to list apparels based on the options you*
** _What it does_: It list the apparels based on  to RestOrRant with the specified number of seats at the table. This table is also stored in `[blue]#*Storage*#` component and displayed on the User Interface.
