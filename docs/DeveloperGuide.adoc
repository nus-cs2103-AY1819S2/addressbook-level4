...
.com/cs2103-ay1819s2-w10-4/main/blob/master/src/main/java/seedu/knowitall/ui/MainWindow.java[`MainWindow`] is
...
.. Other incorrect cd commands to try: `export`, `export -1`, `export 12 13 14`, where `12` `13` and `14` are non
existent card folder indexes.
