...
image::TableModeDiagram.png[width="800"]
...
image::ReceiptFormatDiagram.png[width="800"]
...
image::BillTableStatusDiagram.png[width="800"]
...
image::BillFinalResultDiagram.png[width="650"]
...
image::BillActivityDiagram.png[width="650"]
...
[discrete]
=== Use case: Checking for available tableList
