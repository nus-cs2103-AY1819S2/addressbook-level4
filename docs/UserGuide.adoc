...
4+^|_Patient Prefixes_
|*Prefix* | *Attribute* | *Prefix* | *Attribute*

|a/ | Address | dob/ | Date of Birth
|e/ | Email |ic/ | Nric
|n/ | Name |p/ | Phone
|sex/ | Sex | da/ | Drug Allergy
|nokn/ | Next of Kin Name | nokr/ | Next of Kin Relation
|nokp/ | Next of Kin Phone | noka/ | Next of Kin Address
|desc/ | Description 2+|
4+^|

4+^|_Record Prefixes_
|*Prefix* | *Attribute* | *Prefix* | *Attribute*
|pro/ | Procedure |desc/ | Description
...
Name, NRIC, Sex, and Date of Birth fields are compulsory. The rest are optional fields.
...
|desc/DESCRIPTION | desc/New patient
|===

If a patient’s next of kin lives at the same address, you can use `same` to indicate that!
