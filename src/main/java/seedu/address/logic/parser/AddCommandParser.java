...
public class AddCommandParser implements Parser<AddCommand> {
    ...
    public AddCommand parse(String args) throws ParseException {
        ...
        if (!arePrefixesPresent(argMultimap, PREFIX_NAME, PREFIX_ADDRESS, PREFIX_RATING, PREFIX_DESCRIPTION)
        ...
        Place place = new Place(name, rating, description, address, tagList);
