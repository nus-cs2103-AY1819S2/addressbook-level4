...
* Book name and author name should not exceed 50 characters.
* Review title should not exceed 70 characters.
* Review content should not exceed 350 characters.
* Tags should not exceed 20 characters.
====
...
=== Sort books commands : `sortBook`

sort bookList in specify order. +
Format: `sortBook st/TYPE o/ORDER`

****
* TYPE can be either *AUTHOR*, *NAME* or *RATING*.
...
* `sortBook st/name o/asc`
sort bookList by book name in ascending order.
* `sortBook st/RATING o/des`
sort bookList by rating of the book in descending order.
...
* The summary will also list out atgs appear more than once in your book shelf.
****
