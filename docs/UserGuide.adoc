...
image::ug-diagrams/ui_explanation.png[width="600" align="center"]
...
image::ug-diagrams/pat/ap_after.png[width="600" align="center"]
...
image::ug-diagrams/pat/lp_noargs.png[width="600" align="center"]

If no keywords are entered, `listpat` will simply display the first 50 patients record stored.

`listpat n/P` +

image::ug-diagrams/pat/lp_name_after.png[width="600" align="center"]
...
image::ug-diagrams/pat/lp_nric_after.png[width="600" align="center"]

You can now view all the patient detail entries whose nric starts with S92.

image::ug-diagrams/pat/lp_nric_specific.png[width="600" align="center"]

and then proceed to narrow down the search using the specific patient's nric.

`listpat t/diabetes` +

image::ug-diagrams/pat/lp_tag_after.png[width="600" align="center"]

By specifying the tag to be diabetes, you can list all diabetic patients.

`listpat 5`

image::ug-diagrams/pat/lp_indexes.png[width="600" align="center"]
...
image::ug-diagrams/pat/lp_index.png[width="600" align="center"]
