...
public class BookCommandBoxTest extends GuiUnitTest {
    ...
    private BookCommandBoxHandle commandBoxHandle;
    ...
    public void setUp() {
        ...
        commandBoxHandle = new BookCommandBoxHandle(getChildNode(commandBox.getRoot(),
            BookCommandBoxHandle.COMMAND_INPUT_FIELD_ID));
