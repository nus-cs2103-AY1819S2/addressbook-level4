...
public class MainWindow extends UiPart<Stage> {
    ...
    void fillInnerParts() {
        ...
        StatusBarFooter statusBarFooter = new StatusBarFooter(logic.getPdfBookFilePath(), logic.getPdfBook());
    ...
    public PdfListPanel getPdfListPanel() {
        return pdfListPanel;
    }
     ...
     *
     * @see seedu.pdf.logic.Logic#execute(String)
     */
    private CommandResult executeCommand(String commandText) throws CommandException, ParseException {
        try {
            ...
            browserPanel.updateDefaultPage(logic.getDuePdfs());
