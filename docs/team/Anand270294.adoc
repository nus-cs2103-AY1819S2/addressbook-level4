...
challenge ourselves and decided to morph it into https://github.com/cs2103-ay1819s2-w14-4/main[GradTrak]. +
...
to programming. This section of the guide does not delve into the technical aspects of this application, only showing instructions on how
...
|===
|_Given below are sections I contributed to the Developer Guide, which is showcase my ability to write technical documentations.
...
backend of this application and potentially aid them in improving this product or even morphing it again. _
|===
