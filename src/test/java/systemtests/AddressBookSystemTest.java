...
public abstract class AddressBookSystemTest {
    ...
    protected void showAllPlaces() {
        ...
        assertEquals(getModel().getAddressBook().getPlaceList().size(), getModel().getFilteredPlaceList().size());
    }
    ...
    protected void showPlacesWithName(String keyword) {
        ...
        assertTrue(getModel().getFilteredPlaceList().size() < getModel().getAddressBook().getPlaceList().size());
    }
    ...
    /**
     * Deletes all places in the address book.
     */
    protected void deleteAllPlaces() {
        executeCommand(ClearCommand.COMMAND_WORD);
        assertEquals(0, getModel().getAddressBook().getPlaceList().size());
    }
