...
//
//public class DeleteCommandSystemTest extends RestOrRantSystemTest {
//
...
//         */
//        showPersonsWithName(KEYWORD_MATCHING_MEIER);
//        int invalidIndex = getModel().getRestOrRant().getPersonList().size();
...
//                getModel().getRestOrRant().getPersonList().size() + 1);
...
//     * {@code RestOrRantSystemTest#assertApplicationDisplaysExpected(String, String, Model)}.
