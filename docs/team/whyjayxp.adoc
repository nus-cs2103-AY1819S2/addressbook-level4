...
** What it does: RestOrRant has four modes for each of the four features. Users can switch between modes using commands to use the other features, such as the `restaurantMode` and `tableMode` commands that I implemented.
