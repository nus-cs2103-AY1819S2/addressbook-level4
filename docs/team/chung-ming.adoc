...
* Added {websiteURL}/DeveloperGuide.html#user-stories[User Stories] and {websiteURL}/DeveloperGuide.html#use-cases[Use Cases] to the Developer Guide +
(Pull request: link:{repoURL}/pull/170[#170])
