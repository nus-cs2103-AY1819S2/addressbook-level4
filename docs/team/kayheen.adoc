...
*** Contributed to forum discussions (to be updated) (examples:  https://github.com[1], https://github.com[2], https://github.com[3], https://github.com[4])
*** Reported bugs and suggestions for other teams in the class (to be updated once we review other people's code) (examples:  https://github.com[1], https://github.com[2], https://github.com[3])
...
|===
include::../UserGuide.adoc[tag= A Walk Through]

include::../UserGuide.adoc[tag=Rotate Command]

include::../UserGuide.adoc[tag= Crop Command]

include::../UserGuide.adoc[tag= Resize Command]
...
include::../DeveloperGuide.adoc[tag=Image Manipulation]
