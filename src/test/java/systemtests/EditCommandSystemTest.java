...
import static seedu.address.testutil.TypicalIndexes.INDEX_FIRST_LANDLORD;
...
public class EditCommandSystemTest extends AddressBookSystemTest {
    ...
    public void edit() {
         ...
         * -> edited
         */
        Index index = INDEX_FIRST_LANDLORD;
        String command = " " + EditCommand.COMMAND_WORD + "  " + index.getOneBased() + "  " + NAME_DESC_BOB + "  "
                + PHONE_DESC_BOB + " " + EMAIL_DESC_BOB + "  " + "  " + REMARK_DESC_BOB + "  " + ADDRESS_DESC_BOB
                + " " + RENTALPRICE_DESC_BOB + " " + TAG_DESC_MRT + " ";
        Person editedPerson = new PersonBuilder(BOB).withTags(VALID_TAG_MRT).buildLandlord();
        ...
        model.setPerson(getModel().getFilteredPersonList().get(INDEX_FIRST_BUYER.getZeroBased()), editedPerson);
        assertCommandSuccess(command, model, expectedResultMessage);

        /* Case: edit a person with new values same as existing values -> edited */
        command = EditCommand.COMMAND_WORD + " " + index.getOneBased() + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + TAG_DESC_HDB + TAG_DESC_MRT;
        assertCommandSuccess(command, index, BOB);

        /* Case: edit a person with new values same as another person's values but with different name -> edited */
        assertTrue(getModel().getAddressBook().getPersonList().contains(BOB));
        index = INDEX_SECOND_BUYER;
        ...
        assertCommandFailure(EditCommand.COMMAND_WORD + " " + INDEX_FIRST_BUYER.getOneBased(),
                EditCommand.MESSAGE_NOT_EDITED);

        /* Case: invalid name -> rejected */
        assertCommandFailure(EditCommand.COMMAND_WORD + " " + INDEX_FIRST_BUYER.getOneBased() + INVALID_NAME_DESC,
                Name.MESSAGE_CONSTRAINTS);

        /* Case: invalid phone -> rejected */
        assertCommandFailure(EditCommand.COMMAND_WORD + " " + INDEX_FIRST_BUYER.getOneBased() + INVALID_PHONE_DESC,
                Phone.MESSAGE_CONSTRAINTS);

        /* Case: invalid email -> rejected */
        assertCommandFailure(EditCommand.COMMAND_WORD + " " + INDEX_FIRST_BUYER.getOneBased() + INVALID_EMAIL_DESC,
                Email.MESSAGE_CONSTRAINTS);

        /* Case: invalid address -> rejected */
        assertCommandFailure(EditCommand.COMMAND_WORD + " " + INDEX_FIRST_BUYER.getOneBased() + INVALID_ADDRESS_DESC,
                Address.MESSAGE_CONSTRAINTS);

        /* Case: invalid tag -> rejected */
        assertCommandFailure(EditCommand.COMMAND_WORD + " " + INDEX_FIRST_BUYER.getOneBased() + INVALID_TAG_DESC,
