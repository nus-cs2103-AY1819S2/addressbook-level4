...
* `DAY` has to be within 1 to 31 (Special case: 29, 30 and 31 are only vaild if it exists in the month of a specified
 year).
****
...
a| a| Notice that the first monthly revenue is the most recent month recorded. This saves you from the trouble of
scrolling through the rest of the record.
...
a| a| Notice that the first daily revenue is the most recent day recorded. This saves you from the trouble of
scrolling through the rest of the record.
...
Displays up to 30 revenue from recent years in the Revenue Panel
a|<<Monthly, `monthly`>> a|`*m*` a|`monthly` a|
Displays up to 30 revenue from recent months in the Revenue Panel
a|<<Daily, `daily`>> a|`*d*` a|`daily` a|
Displays up to 30 revenue from recent days in the Revenue Panel
