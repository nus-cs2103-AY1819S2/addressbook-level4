...
//
//        /* Case: undo editing the last doctor in the list -> last doctor restored */
//        command = UndoCommand.COMMAND_WORD;
//        String expectedResultMessage = UndoCommand.MESSAGE_SUCCESS;
//        assertCommandSuccess(command, model, expectedResultMessage);
//
//        /* Case: redo editing the last doctor in the list -> last doctor edited again */
//        command = RedoCommand.COMMAND_WORD;
//        expectedResultMessage = RedoCommand.MESSAGE_SUCCESS;
//        model.setDoctor(getModel().getFilteredDoctorList().get(INDEX_FIRST_PERSON.getZeroBased()), editedDoctor);
//        assertCommandSuccess(command, model, expectedResultMessage);
//
...
//
//        /* Case: edit a doctor with new values same as another doctor's values but with different name -> edited */
//        assertTrue(getModel().getDocX().getPatientList().contains(BOB));
//        index = INDEX_SECOND_PERSON;
//        assertNotEquals(getModel().getFilteredDoctorList().get(index.getZeroBased()), STEVEN);
//        command = EditDoctorCommand.COMMAND_WORD + " " + index.getOneBased() + NAME_DESC_ALVINA
//                + GENDER_DESC_STEVEN + YEAR_DESC_STEVEN + PHONE_DESC_STEVEN
//                + SPECIALISATION_DESC_MASSAGE + SPECIALISATION_DESC_ACUPUNCTURE;
//        editedDoctor = new DoctorBuilder(STEVEN).withName(VALID_NAME_ALVINA).build();
//        assertCommandSuccess(command, index, editedDoctor);
//
...
//        command = EditDoctorCommand.COMMAND_WORD + " " + index.getOneBased() + " " + NAME_DESC_STEVEN;
//        doctorToEdit = getModel().getFilteredDoctorList().get(index.getZeroBased());
...
//        index = INDEX_FIRST_PERSON;
//        assertFalse(getModel().getFilteredDoctorList().get(index.getZeroBased()).equals(STEVEN));
//        command = EditDoctorCommand.COMMAND_WORD + " " + index.getOneBased() + NAME_DESC_STEVEN
//                + GENDER_DESC_STEVEN + YEAR_DESC_STEVEN + PHONE_DESC_STEVEN
//                + SPECIALISATION_DESC_MASSAGE + SPECIALISATION_DESC_ACUPUNCTURE;
...
//        command = EditDoctorCommand.COMMAND_WORD + " " + index.getOneBased() + NAME_DESC_STEVEN
//                + GENDER_DESC_ALVINA + YEAR_DESC_STEVEN + PHONE_DESC_STEVEN
//                + SPECIALISATION_DESC_MASSAGE + SPECIALISATION_DESC_ACUPUNCTURE;
//        assertCommandFailure(command, EditDoctorCommand.MESSAGE_DUPLICATE_DOCTOR);
//
...
//         */
//        command = EditDoctorCommand.COMMAND_WORD + " " + index.getOneBased() + NAME_DESC_STEVEN
//                + GENDER_DESC_STEVEN + YEAR_DESC_ALVINA + PHONE_DESC_STEVEN
//                + SPECIALISATION_DESC_MASSAGE + SPECIALISATION_DESC_ACUPUNCTURE;
//        assertCommandFailure(command, EditDoctorCommand.MESSAGE_DUPLICATE_DOCTOR);
//
//        /* Case: edit a doctor with new values same as another doctor's values but with different phone -> rejected */
//        command = EditDoctorCommand.COMMAND_WORD + " " + index.getOneBased() + NAME_DESC_STEVEN
//                + GENDER_DESC_STEVEN + YEAR_DESC_STEVEN + PHONE_DESC_ALVINA
//                + SPECIALISATION_DESC_MASSAGE + SPECIALISATION_DESC_ACUPUNCTURE;
//        assertCommandFailure(command, EditDoctorCommand.MESSAGE_DUPLICATE_DOCTOR);
