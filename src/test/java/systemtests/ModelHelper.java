...
public class ModelHelper {
    private static final Predicate<Record> PREDICATE_MATCHING_NO_PERSONS = unused -> false;
    ...
    public static void setFilteredList(Model model, List<Record> toDisplay) {
        ...
        model.updateFilteredRecordList(predicate.orElse(PREDICATE_MATCHING_NO_PERSONS));
    }
