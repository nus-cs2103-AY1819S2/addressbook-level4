...
public class FilterCommandParserTest {
    ...
    public void parse_emptyFields_failure() {
        ...
        assertParseFailure(parser, AND_TYPE + EMPTY_FIELD_EDUCATION,
                FilterCommandParser.MESSAGE_INPUT_NOT_IN_TRUE_FORM);

        assertParseFailure(parser, AND_TYPE + EMPTY_FIELD_EMAIL,
                FilterCommandParser.MESSAGE_INPUT_NOT_IN_TRUE_FORM);

        assertParseFailure(parser, AND_TYPE + EMPTY_FIELD_ENDORSEMENT,
                FilterCommandParser.MESSAGE_INPUT_NOT_IN_TRUE_FORM);

        assertParseFailure(parser, AND_TYPE + EMPTY_FIELD_GPA,
                FilterCommandParser.MESSAGE_INPUT_NOT_IN_TRUE_FORM);

        assertParseFailure(parser, AND_TYPE + EMPTY_FIELD_NAME,
                FilterCommandParser.MESSAGE_INPUT_NOT_IN_TRUE_FORM);

        assertParseFailure(parser, AND_TYPE + EMPTY_FIELD_PHONE,
                FilterCommandParser.MESSAGE_INPUT_NOT_IN_TRUE_FORM);

        assertParseFailure(parser, AND_TYPE + EMPTY_FIELD_POS,
                FilterCommandParser.MESSAGE_INPUT_NOT_IN_TRUE_FORM);
    ...
    public void parse_validFields_success() {
        ...
        String[] criterionEducation = {null, null, null, null, null, null, null, "NUS".trim().toLowerCase(), null};
        ...
        String[] criterionEmail = {null, null, "e@ex".trim().toLowerCase(), null, null, null, null, null, null};
        ...
        String[] criterionGpa = {null, null, null, null, null, null, "3.1".trim().toLowerCase(), null, null};
        ...
        String[] criterionName = {"Neill".trim().toLowerCase(), null, null, null, null, null, null, null, null};
        ...
        String[] criterionPhone = {null, "92".trim().toLowerCase(), null, null, null, null, null, null, null};
