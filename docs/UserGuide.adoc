...
[%autowidth]
|===
| image:tip.png[width="40"] |You can view help by click the `Help button on the Menu Bar.
|===
...
[%autowidth]
|===
| image:tip.png[width="40"] |An equipment can any number of tags (including 0).
|===
...
[%autowidth]
|===
| image:tip.png[width="40"] |The user can enter multiple field name and values.
|===
...
Format: `edit INDEX [n/CLENT_NAME] [p/CLIENT_PHONE] [pm/PM_DATE] [a/CLIENT_ADDRESS] [s/SERIAL_NUMBER] [t/TAG]…​`
...
[%autowidth]
|===
| image:tip.png[width="40"] |Equipment, client, and work list can only be sorted by address, preventive maintenance date and phone at the moment.
|===
...
[%autowidth]
|===
| image:lightbulb.png[width="40"] |Pressing the kbd:[&uarr;] and kbd:[&darr;] arrows will display the previous and next input respectively in the command box.
|===
...
[%autowidth]
|===
| image:lightbulb.png[width="40"] |Undoable commands: those commands that modify the address book's content (`add`, `delete`, `edit` and `clear`).
|===
