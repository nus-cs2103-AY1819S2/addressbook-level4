...
|===
|_Given below are highlights of some my contribution to the User Guide. They showcase my ability to write documentation targeting end-users._
|===
=== *Features*
'''
...
|===
|_Given below are highlights of some my contribution to the Developer Guide. They showcase my ability to write technical documentation and the technical depth of my contributions to the project._
|===
