...
public class UserPrefs implements ReadOnlyUserPrefs {
    ...
    public void resetData(ReadOnlyUserPrefs newUserPrefs) {
        ...
        setTravelBuddyFilePath(newUserPrefs.getTravelBuddyFilePath());
    }
    ...
    public boolean equals(Object other) {
        ...
        return guiSettings.equals(o.guiSettings)
                && travelBuddyFilePath.equals(o.travelBuddyFilePath);
    }

    @Override
    public int hashCode() {
        return Objects.hash(guiSettings, travelBuddyFilePath);
    }
