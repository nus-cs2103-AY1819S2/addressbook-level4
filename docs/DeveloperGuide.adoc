...
1. User requests to list persons
2. slaveFinder() shows a list of persons
3. User requests to view analytics for list of persons
...
=== Searching a list of persons

. Searching a list of person while all persons are listed

.. Prerequisites: List all persons using the `list` command. Multiple persons in the list.
.. Test case: `search m/CS` +
   Expected: All persons with major CS will show on the list
