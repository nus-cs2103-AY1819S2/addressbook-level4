...
==== Current Implementation: Task management commands
...
. Result from the command's execution gets sent back to the user

The following sequence diagram shows the generic flow in which these basic commands are executed in the application:
