 ...
 */
public class PopularMenuListPanel extends UiPart<Region> {
    private static final String FXML = "PopularMenuListPanel.fxml";
    private final Logger logger = LogsCenter.getLogger(PopularMenuListPanel.class);

    @FXML
    private ListView<MenuItem> menuItemListView;

    public PopularMenuListPanel(ObservableList<MenuItem> menuItemList, ObservableValue<MenuItem> selectedMenuItem,
