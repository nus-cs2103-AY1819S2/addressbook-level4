...
The import/export feature currently contains 2 commands to perform the following operations.

* 'import feature' - Imports the selected CSV file and load the current progress of the user.
* `export feature` - Exports the current progress of the user into a CSV file.

NOTE: These functions are automatically performed on opening/closing the Session.

==== Design Considerations
* ** Alternative 1(Current choice): Automate import/exporting when session is open/close
