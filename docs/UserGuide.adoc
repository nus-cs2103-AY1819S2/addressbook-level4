...
image::importCommand.PNG[width="700"]
+
...
+
.Import Success
image::importSuccess.PNG[width="700"]
+

.  Open the imported image in FomoFoto by typing as follows:
+
.Open Command
image::open.PNG[width="700"]
+
...
+
.Brightness Command
image::brightnessCommand.PNG[width="700"]
+

.  Press kbd:[Enter]. Your image should be brighter as shown in the figure below.
+
.Brightness Success
image::brightnessSuccess.PNG[width="700"]
+
...
+
.Crop Success
image::cropSuccess.PNG[width="700"]
+
