    ...
    public static Person[] getSamplePersons() {
        return new Person[] {
                new Person(new Name("Alex Yeoh"), new Phone("87438807"), new Email("alexyeoh@example.com"),
                        new Education("NUS"), new Gpa("3.2"), new Degree("Bachelors"), new Address("Blk 30 Geylang Street 29, #06-40"),
                ...
                new Person(new Name("Bernice Yu"), new Phone("99272758"), new Email("berniceyu@example.com"),
                        new Education("NUS"), new Gpa("3.5"),new Degree("Associates"), new Address("Blk 30 Lorong 3 Serangoon Gardens, #07-18"),
                ...
                new Person(new Name("Charlotte Oliveiro"), new Phone("93210283"), new Email("charlotte@example.com"),
                        new Education("NUS"), new Gpa("3.0"), new Degree("Bachelors"), new Address("Blk 11 Ang Mo Kio Street 74, #11-04"),
                        getTagSet(Arrays.asList("C++", "Java", "Swift", "Certificates", "Networking"), Arrays.asList(
                                "Cyber Crime "),
                                Arrays.asList("Barack Obama"))),
                new Person(new Name("David Li"), new Phone("91031282"), new Email("lidavid@example.com"),
                        new Education("NUS"), new Gpa("3"), new Degree("Bachelors"), new Address("Blk 436 Serangoon Gardens Street 26, #16-43"),
                ...
                new Person(new Name("Irfan Ibrahim"), new Phone("92492021"), new Email("irfan@example.com"),
                        new Education("NUS"), new Gpa("4.0"), new Degree("Bachelors"), new Address("Blk 47 Tampines Street 20, #17-35"),
                ...
                new Person(new Name("Susan McDonald"), new Phone("35810495"), new Email("susanM@gmail.com"),
                        new Education("Yale"), new Gpa("4.0"), new Degree("Bachelors"), new Address("32 Independence Way, New York NY"),
                ...
                new Person(new Name("Tony Stark"), new Phone("92874639"), new Email("tonys@avengers.com"),
                        new Education("MIT"), new Gpa("4.0"), new Degree("PHD"), new Address("911 Avengers Way, New York NY"),
                ...
                new Person(new Name("Bruce Wayne"), new Phone("92875639"), new Email("bruce@wayne.com"),
                        new Education("Stanford"), new Gpa("3.6"), new Degree("Bachelors"), new Address("1 Wayne Manor, New York NY"),
                ...
                new Person(new Name("Peter Parker"), new Phone("92874339"), new Email("peterp@gmail.com"),
                        new Education("Brooklyn High School"), new Gpa("2.0"), new Degree("High school"), new Address("99 Sunflower Dr, Brooklyn "
                ...
                new Person(new Name("Claire Smith"), new Phone("98765432"), new Email("claireS@gmail.com"),
                        new Education("Oxford"), new Gpa("2.7"), new Degree("PHD"), new Address("12 Biscuits Way, Oxford"),
                        getTagSet(Arrays.asList("C#", "PHP", "Linux", "C++", "Finance"), Arrays.asList("Systems "
                                + "Analyst"), Arrays.asList("Elon Musk"))),
                new Person(new Name("Roy Balakrishnan"), new Phone("92624417"), new Email("royb@example.com"),
                        new Education("NUS"), new Gpa("2.1"), new Degree("Masters"), new Address("Blk 45 Aljunied Street 85, #11-31"),
