...
/**
 * Selects a request identified using it's displayed index.
 */
public class SelectCommand extends Command {
    ...
    public static final String MESSAGE_USAGE = COMMAND_WORD
            + ": Selects the request identified by the index number used in the displayed requestA list.\n"
            + "Parameters: INDEX (must be a positive integer)\n"
            + "Example: " + COMMAND_WORD + " 1";

    public static final String MESSAGE_SELECT_SUCCESS = "Selected Request: %1$s";
