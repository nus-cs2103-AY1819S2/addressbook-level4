...
public class JsonAddressBookStorageTest {
    ...
    @Test
    public void readAddressBook_invalidMedicineAddressBook_throwDataConversionException() throws Exception {
        thrown.expect(DataConversionException.class);
        readAddressBook("invalidMedicineAddressBook.json");
    }

    @Test
    public void readAddressBook_invalidAndValidMedicineAddressBook_throwDataConversionException() throws Exception {
        thrown.expect(DataConversionException.class);
        readAddressBook("invalidAndValidMedicineAddressBook.json");
    }
