...
// tag::csvstorage[]
=== CSV Lessons storage feature
==== Current Implementation
The lesson CSV storage feature implements the following functions:

* Parsing lesson data into the a list of string arrays, which is a format opencsv accepts for saving to CSV.
...
===== Name
Lesson names are equivalent to their file names.
