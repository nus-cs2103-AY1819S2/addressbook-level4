...
[maroon]#You can list all the commands you have entered in reverse chronological order.#
...
[maroon]#You can delete all existing entries in the records and reset your budget to $0.00.#
...
[maroon]#You can quit the program at any point in time when you use this command.#
...
// tag::savingpatterns[]
==== Establish saving patterns based on record and derive projected savings/expenses in a time span `[[fuchsia]#coming in v2.0#]`
...
==== Links to financial articles `[[fuchsia]#coming in v2.0#]`
