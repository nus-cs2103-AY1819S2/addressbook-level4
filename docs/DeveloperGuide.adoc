...
2.  System changes course of study to course intended by user.
+
Use case ends.
...
[none]
** 1a1. System informs user that no such course is available. +
Use case ends.
[none]
* 1b. User enters `study` without parameter. +
[none]
** 1b1. System informs user of the right command format. +
Use case ends.
