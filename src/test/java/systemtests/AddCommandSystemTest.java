...
public class AddCommandSystemTest extends AddressBookSystemTest {
     ...
     * {@code toAdd}.<br>
     * 4. {@code MedicineManager} and {@code PersonListPanel} equal to the corresponding components in
     ...
     * 2. {@code MedicineManager} and {@code PersonListPanel} equal to the corresponding components in
     ...
     * 4. {@code MedicineManager} and {@code PersonListPanel} remain unchanged.<br>
