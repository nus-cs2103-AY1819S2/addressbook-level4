...
1. User enter select command followed by search criteria
2. Quickdocs show prompt that indicates to user that he or she is currently editing a consultation report
3. User enter symptoms
4. Quickdocs indicate to user that the symptom is recorded
5. User enters “end”
6. Quickdocs shows prompt to indicate user that he or she is now editing the prescription for this session.
7. User enter medicine administered followed by frequency of use
8. Quickdocs indicate to user medicine is added
9. User enters end
10. Quickdocs indicate to user that the consultation has ended.
+
Use case ends.
...
Use case ends here.
[none]
* 1b. No patient records created yet
[none]
** 1b1. Quickdocs alert user that no patient is created yet, suggest to create a new patient record first
+
Use case ends here.
[none]
...
+
[none]
** 3a1. Quickdocs display message to user that last symptom added is undone.
** 3a2. Quickdocs prompts user to reenter symptom.
** 3a3. User re-enter symptom
+
Use case resumes at step 3.
[none]
* 7a. User enters “undo”
[none]
** 7a1. Quickdocs display message to user that last prescribed medicine is removed.
** 7a2. Quickdocs prompts user to reenter medicine.
** 7a3. User re-enter medicine
+
...
[discrete]
=== Use case: Choosing an appointment slot
...
3. User search for patient’s index by viewing patient records with search criteria
4. User enter command to add appointment slot and specifies date
5. Quickdocs displays free slots for the chosen date
6. Quickdocs prompts the user for the start time of the appointment slot
7. User enters start time
8. Quickdocs prompts the user for the end time of the appointment slot
9. User enters end time
10. Quickdocs displays a successful message, showing the details of the newly created appointment slot
+
Use case ends
...
[none]
* 4a. User enters invalid index or date
[none]
** 4a1. Quickdocs displays an error message
+
Use case resumes from step 4.
[none]
* 10a. Quickdocs displays an error message, showing clashes in timing with another appointment slot
+
Use case ends here.
[none]
* 10b. Patient wants to change appointment slot timing
[none]
** 10b1. User enter command to delete appointment slot, specifying date and time
** 10b2. Quickdocs prompts user with a confirmation message to delete the appointment slot (Y/N)
** 10b3. User enters Y and appointment slot is removed
+
Use case ends here.
...
[discrete]
=== User case: Record purchase of medicine
