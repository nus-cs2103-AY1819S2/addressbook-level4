...
image:InvalidWeblinkEdit.PNG[width=800]
...
image:NoInternetEdit.PNG[width=800]
// end::addedit[]
...
* `list` +
`visitWeb 4` +
This command displays webpage of the restaurant at index 4 of list as shown below.

image::visitWeb.PNG[width=800]


* `visitWeb www.jollibee.com.ph` +
This command displays webpage of Jollibee as shown below.

image::visitWebJolliB.PNG[width="800"]
