...
* **`add`**`c/seller n/James Ho p/98765432 e/jamesho@example.com r/urgent need to sell a/123, Clementi Rd, S123456` sp/500000: adds a seller named `James Ho` and the associated property information to the address book.
