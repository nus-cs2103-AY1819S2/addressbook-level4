...
|===
|_Given below are sections I contributed to the User Guide. They showcase my ability to write documentation targeting end-users. Note that the horizontal lines indicate that they are taken from different sections of the User Guide.__
|===

include::../UserGuide.adoc[tag=map]

---
== Upcoming Feature in v2.0
...
|===
|_Given below are sections I contributed to the Developer Guide. They showcase my ability to write technical documentation and the technical depth of my contributions to the project. Note that the horizontal lines indicate that they are taken from different sections of the Developer Guide._
|===

Co-authored the Model diagram as shown in Figure 3 below.
