...
public class PdfTest {
    ...
    public void isSamePerson() {
        ...
        Pdf editedAlice = new PersonBuilder(ALICE).withPhone(VALID_PHONE_BOB).withEmail(VALID_EMAIL_BOB).build();
    ...
    public void equals() {
        ...
        Pdf aliceCopy = new PersonBuilder(ALICE).build();
        ...
        // different name -> returns false
        Pdf editedAlice = new PersonBuilder(ALICE).withName(VALID_NAME_BOB).build();
