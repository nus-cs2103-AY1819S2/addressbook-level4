...
* `BudgetPanel` of UI
** *_What it does_*: Allows user to see the total spending against total budget so far in a visual progress bar.
Depending on how close the total spending is to the total budget, the colour of the bar will change accordingly.
** *_Justification_*: This feature will allows users to have a visual view of their total spending against their set
budget
** *_Highlights of feature:_*
*** This feature will be updated every time a user `spends`, `edit` the amount in the records, or `delete` a record
...
1) https://github.com/CS2103-AY1819S2-W17-3/main/blob/master/docs/DeveloperGuide.adoc#budget-management[`show` implementation] +
2)https://github.com/CS2103-AY1819S2-W17-3/main/blob/master/docs/DeveloperGuide.adoc#theme[`theme` implementation]
|===
