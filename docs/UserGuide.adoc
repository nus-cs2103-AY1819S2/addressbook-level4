...
* *memberAdd* : `memberAdd n/NAME an/ADMIN_NUMBER p/PHONE_NUMBER e/EMAIL yos/YEAR_OF_STUDY m/MAJOR [t/TAG]...`
 +
e.g. `memberAdd n/James Ong an/A0123456Y p/98765432 e/jamesong@example.com yos/year1 m/mathematics`
* *memberClear* : `memberClear`
* *memberDelete* : `memberDelete INDEX` +
e.g. `memberDelete 3`
* *memberEdit* : `memberEdit INDEX [n/NAME] [p/PHONE_NUMBER] [e/EMAIL] [a/ADDRESS] [t/TAG]...` +
e.g. `memberEdit 2 n/James Lee e/jameslee@example.com`
* *memberFind* : `memberFind KEYWORD [MORE_KEYWORDS]` +
e.g. `memberFind John`
* *memberList* : `list`
* *help* : `help`
* *memberSelect* : `memberSelect INDEX` +
e.g.`memberSelect 2`
