...
* 'PostalDataSet#checkPostal(int postal)' -- returns the 'PostalData' corresponding to the postal code provided.

This operation is exposed in the `Model` interface as `Model#checkPostal(int postal) (TBD)

Given below is an example usage scenario and how the 'PostalDataSet' behaves at each step.
