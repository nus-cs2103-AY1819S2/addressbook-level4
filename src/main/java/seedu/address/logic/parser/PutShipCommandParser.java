...
public class PutShipCommandParser implements Parser<PutShipCommand> {
    ...
    public PutShipCommand parse(String args) throws ParseException {
        ...
        Coordinate coordinate = ParserUtil.parseCoordinate(argMultimap.getValue(PREFIX_NAME).get());
        Set<Tag> tagList = ParserUtil.parseTags(argMultimap.getAllValues(PREFIX_TAG));

        Battleship battleship = new Battleship(name, tagList);

        return new PutShipCommand(battleship);
    }
