...
class JsonSerializableRestOrRant {
     ...
     */
    @JsonCreator
    public JsonSerializableRestOrRant(@JsonProperty("persons") List<JsonAdaptedPerson> persons) {
     ...
     */
    public JsonSerializableRestOrRant(ReadOnlyRestOrRant source) {
