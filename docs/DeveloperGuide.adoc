...
* stores the Address Book, Archive Book and Pin Book data.
...
[NOTE]
ArchiveBook and PinBook are similarly implemented to facilitate the undo/redo mechanism.
...
|`* * *` |sloppy user |add and edit a contact in the app without having to specify all the contact information (i.e. all fields are optional) |add and edit a contact even if I do not have the complete contact information
...
2. TheRealApp requests for confirmation.
3. User confirms the request.
4. TheRealApp clears the entire archived contact list.
+
Use case ends.
