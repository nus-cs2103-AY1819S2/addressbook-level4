...
public class HistoryCommandTest {
    ...
    public void execute() {
        ...
        assertCommandSuccess(new HistoryCommand(), model, history,
                String.format(HistoryCommand.MESSAGE_SUCCESS, command1), expectedModel, currentEdit);
        ...
        assertCommandSuccess(new HistoryCommand(), model, history, expectedMessage, expectedModel, currentEdit);
    }
