...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, QUESTION_DESC_AMY + QUESTION_DESC_BOB + ANSWER_DESC_BOB + ADDRESS_DESC_BOB
                + HINT_DESC_FRIEND, new AddCommand(expectedCard));

        // multiple answers - last answer accepted
        assertParseSuccess(parser, QUESTION_DESC_BOB + ANSWER_DESC_AMY + ANSWER_DESC_BOB + ADDRESS_DESC_BOB
                + HINT_DESC_FRIEND, new AddCommand(expectedCard));

        // multiple addresses - last address accepted
        assertParseSuccess(parser, QUESTION_DESC_BOB + ANSWER_DESC_BOB + ADDRESS_DESC_AMY + ADDRESS_DESC_BOB
                + HINT_DESC_FRIEND, new AddCommand(expectedCard));
        ...
        Card expectedCardMultipleTags = new CardBuilder(BOB).withHint(VALID_HINT_FRIEND, VALID_HINT_HUSBAND)
                .build();
        assertParseSuccess(parser, QUESTION_DESC_BOB + ANSWER_DESC_BOB + ADDRESS_DESC_BOB + HINT_DESC_HUSBAND
    ...
    public void parse_optionalFieldsMissing_success() {
        ...
        assertParseSuccess(parser, QUESTION_DESC_AMY + ANSWER_DESC_AMY + ADDRESS_DESC_AMY,
    ...
    public void parse_compulsoryFieldMissing_failure() {
        ...
        // missing name prefix
        assertParseFailure(parser, VALID_QUESTION_BOB + ANSWER_DESC_BOB + ADDRESS_DESC_BOB,
                expectedMessage);

        // missing answer prefix
        assertParseFailure(parser, QUESTION_DESC_BOB + VALID_ANSWER_BOB + ADDRESS_DESC_BOB,
                expectedMessage);

        // missing address prefix
        assertParseFailure(parser, QUESTION_DESC_BOB + ANSWER_DESC_BOB + VALID_ADDRESS_BOB,
                expectedMessage);

        // all prefixes missing
        assertParseFailure(parser, VALID_QUESTION_BOB + VALID_ANSWER_BOB + VALID_ADDRESS_BOB,
                expectedMessage);
    }
    ...
    public void parse_invalidValue_failure() {
        // invalid name
        assertParseFailure(parser, INVALID_QUESTION_DESC + ANSWER_DESC_BOB + ADDRESS_DESC_BOB
                + HINT_DESC_HUSBAND + HINT_DESC_FRIEND, Question.MESSAGE_CONSTRAINTS);

        // invalid answer
        assertParseFailure(parser, QUESTION_DESC_BOB + INVALID_ANSWER_DESC + ADDRESS_DESC_BOB
                + HINT_DESC_HUSBAND + HINT_DESC_FRIEND, Answer.MESSAGE_CONSTRAINTS);

        // invalid address
        assertParseFailure(parser, QUESTION_DESC_BOB + ANSWER_DESC_BOB + INVALID_ADDRESS_DESC
                + HINT_DESC_HUSBAND + HINT_DESC_FRIEND, Address.MESSAGE_CONSTRAINTS);

        // invalid hint
        assertParseFailure(parser, QUESTION_DESC_BOB + ANSWER_DESC_BOB + ADDRESS_DESC_BOB
                + INVALID_HINT_DESC + VALID_HINT_FRIEND, Hint.MESSAGE_CONSTRAINTS);

        // two invalid values, only first invalid fullAnswer reported
        assertParseFailure(parser, INVALID_QUESTION_DESC + ANSWER_DESC_BOB + INVALID_ADDRESS_DESC,
