...
import static seedu.travel.MainApp.GOOGLE_API_KEY;
...
public class BrowserPanel extends UiPart<Region> {
    ...
    /**
     * Loads the Google Maps with the given travel.
     */
    private void loadMapsPage(String address) {
        //try {
        //GeocodingResult[] results =  GeocodingApi.geocode(CONTEXT, travel)..await();
    ...
    /**
     * Redirects to the loadsMapPage() with a specified travel.
     */
