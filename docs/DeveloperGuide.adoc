...
After forking the repo, the documentation will still have the cs2103-ay1819s2-t12-3 branding and refer to the `cs2103-ay1819s2-t12-3/addressbook-level4` repo.

If you plan to develop this fork as a separate product (i.e. instead of contributing to `cs2103-ay1819s2-t12-3/addressbook-level4`), you should do the following:
...
Reference: https://www.powerpak.com/course/content/114338
