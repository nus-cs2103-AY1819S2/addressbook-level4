...
Format: `{[aqua]#findbookingcontainspayer#/[aqua]#fbcp#} [lime]#PAYER_IDENTIFICATION_NUMBER#`
...
==== [underline]#Generate bill for specific booking# : `generate-bill-booking`, `gb-b`

Effect: Generates the bill for the specific booking of a customer +
Format: `{[aqua]#generate-bill-booking#/[aqua]#gb-b#} [lime]#INDEX# [black]#[# [blue]#r/# [lime]#ROOM_TYPE# [black]#]# [black]#[# [blue]#d/# [lime]#START_DATE - END_DATE# [black]#]#`
...
==== [underline]#Generate bill for specific reservation# : `generate-bill-reservation`, `gb-r`

Effect: Generates the bill for the specific booking of a customer +
Format: `{[aqua]#generate-bill-reservation#/[aqua]#gb-r#} [lime]#INDEX# [black]#[# [blue]#s/# [lime]#SERVICE_NAME# [black]#]# [black]#[# [blue]#:/# [lime]#START_TIME - END_TIME# [black]#]#`
...
==== [underline]#Generate customer's bill# : `generate-bill-customer`, `gb-c`
