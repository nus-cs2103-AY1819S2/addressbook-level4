...
import seedu.address.logic.commands.exceptions.WrongScreenException;
...
public interface Logic {
     ...
     */
    CommandResult execute(String commandText, boolean isAllJobScreen) throws CommandException, ParseException;
    ...
    /** Returns an unmodifiable view of the filtered list people in job */
    ObservableList<Person> getJobsList(int k);
     ...
     *
     * @see seedu.address.model.Model#selectedJobProperty()
     */
