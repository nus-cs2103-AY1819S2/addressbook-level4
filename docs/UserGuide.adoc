...
[TIP]
* for every field, using `< or >` can cause false results. Please do not use them in filtering criterion texts.
* all the fields are optional but at least one field should be used
...
* `filter or phone<91234567>phone email<johndoemail@example.com>e skill<C++, Java>skill end<2>end` +
