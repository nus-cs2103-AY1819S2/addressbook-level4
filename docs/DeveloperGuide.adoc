...
which is an indicator that the `File` is a *PDF* file that is uncorrupted and
...
the encrypt command will prompt you to re-enter the password as a form of confirmation message.
...
The part where it is implemented differently will be specifically mentioned for your convenience.
