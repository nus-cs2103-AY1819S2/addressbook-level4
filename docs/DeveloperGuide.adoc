...
image::inputStatsCommandSS.png[width=400]

Pop-up window for `stats` :

image::StatsWindowSS.png[width=800]
Figure 33. Screenshot of empty statistics pop-up window.
...
image::StatsWindowUpdatedSS.PNG[width=800]
Figure 34. Screenshot of populated statistics pop-up window.
...
image::StatsSequenceDiagram.PNG[width=1000 ]
Figure 35. Sequence diagram of `stats` command.
...
image::SaveSequenceDiag.PNG[width=1000]
Figure 36. Sequence diagram of how the statistics data is saved.

The following sequence diagram summarizes what happens at the end of the game and an automatic reading of previous
statistics data is performed.

image::ReadSequenceDiagram.PNG[width=1000]
Figure 37. Sequence diagram of how the previous statistics data is read from storage.

==== Activity Diagram
The following Activity Diagram shows when the `stats` command can be used.

image::StatisticsActivityDiagram.png[width=1000]
Figure 38. Activity Diagram of the statistics feature.

==== Use Case Diagram
The following use-case diagram captures the behaviour of the statistics feature.

image::StatsUseCaseDiag.PNG[width=500]
Figure 39. Use case diagram on the statistics feature.
