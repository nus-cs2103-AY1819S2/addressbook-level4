...
public class SystemTestSetupHelper {
     ...
     */
    public TestApp setupApplication(Supplier<ReadOnlyHealthWorkerBook> healthWorkerBookSupplier,
                                    Path healthWorkerBookPath, Supplier<ReadOnlyRequestBook> requestBookSupplier,
                                    Path requestBookPath) {
        try {
            FxToolkit.registerStage(Stage::new);
            FxToolkit.setupApplication(() -> testApp = new TestApp(healthWorkerBookSupplier, healthWorkerBookPath,
                    requestBookSupplier, requestBookPath));
