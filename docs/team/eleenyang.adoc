...
** Documentation:
*** Update diagrams DeveloperGuide. (Pull request https://github.com/cs2103-ay1819s2-w11-4/main/pull/17[#17], https://github.com/cs2103-ay1819s2-w11-4/main/pull/21[#21])
*** Update User Guide and Developer Guide: (Pull request https://github.com/cs2103-ay1819s2-w11-4/main/pull/95[#95])
