...
include::../UserGuide.adoc[tag=addHealthWorker]

include::../UserGuide.adoc[tag=editHealthWorker]

include::../UserGuide.adoc[tag=listHealthWorker]

include::../UserGuide.adoc[tag=delHealthWorker]
