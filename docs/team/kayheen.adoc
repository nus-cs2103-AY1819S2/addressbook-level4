...
== PROJECT: FomoFoto: an Image Editor
---
...
** Documentation:
*** Did Developer Guide architecture and sequence diagram for the overall application: https://github.com/CS2103-AY1819S2-W14-2/main/pull/84[#84], https://github.com/CS2103-AY1819S2-W14-2/main/pull/118[#118]
...
== 5. Other Works Contributed to the User Guide and Developer Guide not Mentioned Above
* Crop Command
* Resize Command