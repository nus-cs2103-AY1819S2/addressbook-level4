...
.. Test case: `deleteBook 1` +
   Expected: The first book in the list is deleted from the list. Details of the deleted contact shown in the status message. Timestamp in the status bar is updated.
