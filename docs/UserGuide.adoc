...
* When this menu appears, if you press kbd:[control] on your keyboard, you should
see the menu change as shown in the image below.

image::UGAddPathMac2.png[width="200"]

* Now if you press the button highlighted in *blue*, you have successfully copied
...
[NOTE]
You can enter `add` and hit kbd:[enter], to open up a GUI for you to select the file you
wish to add.

Step 4: Upon hitting kbd:[enter] to execute the command, the *AddCommandParser* parses the input
...
[NOTE]
As of v1.4, the Add feature is only capable of adding 1 `Pdf` file at a time. By v2.0,
...
Please refer to <<Encryption Guide, Encryption Guide>> or <<Decryption Guide, Decryption Guide>>
...
Please refer to <<Adding a file: `add`, add feature>> guide in understanding
how you can add your files into PDF++ that you wish to encrypt.
...
<<Opening a file : `open`, open feature>> guide in understanding the `open` feature.
...
Please refer to <<Adding a file: `add`, add feature>> guide in understanding
how you can add your files into PDF++ that you wish to decrypt.
