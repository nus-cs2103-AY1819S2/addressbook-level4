...
If you are adding a restaurant when there is no internet connection, the Food Diary will add your restaurant without the Weblink.

image:NoInternetAdd.PNG[width=640]

_Image 1.1 Result of adding a Restaurant with Weblink when there is no internet connection_
