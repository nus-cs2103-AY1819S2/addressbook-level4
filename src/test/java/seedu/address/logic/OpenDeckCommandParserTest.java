...
public class OpenDeckCommandParserTest {

    private static final String MESSAGE_INVALID_FORMAT = String
            .format(MESSAGE_INVALID_COMMAND_FORMAT, OpenDeckCommand.MESSAGE_USAGE);

    private Model model = new ModelManager(getTypicalTopDeck(), new UserPrefs());
    private OpenDeckCommandParser parser = new OpenDeckCommandParser((DecksView) model.getViewState());
    ...
    public void parse_validIndex_success() {
        ...
        OpenDeckCommand expectedCommand = new OpenDeckCommand(targetIndex, (DecksView) model.getViewState());
