...
For new user, jump to <<Quick Start>> for an overview on how to use FomoFoto and the tools available.
...
[NOTE]
Images should be of the following formats: `bmp`, `jpg` , `png`, `tif` or `gif`
