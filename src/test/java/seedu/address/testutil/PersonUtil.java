...
public class PersonUtil {
     ...
     */
    public static String getMemberAddCommand(Person person) {
        return MemberAddCommand.COMMAND_WORD + " " + getPersonDetails(person);
    }
    ...
    public static String getPersonDetails(Person person) {
        ...
        sb.append(PREFIX_MATRICNUMBER + person.getMatricNumber().value + " ");
    ...
    public static String getEditPersonDescriptorDetails(EditPersonDescriptor descriptor) {
        ...
        descriptor.getYearOfStudy().ifPresent(yearOfStudy -> sb.append(PREFIX_YEAROFSTUDY).append(yearOfStudy.value)
                .append(" "));
