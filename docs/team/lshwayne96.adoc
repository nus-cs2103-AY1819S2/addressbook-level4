...
** Community:
*** Helped with my teammate's feature (checking of graduation requirements) which is closely related to mine (https://github.com/cs2103-ay1819s2-w14-4/main/pull/91/files[#91], https://github.com/cs2103-ay1819s2-w14-4/main/pull/100[#100])
