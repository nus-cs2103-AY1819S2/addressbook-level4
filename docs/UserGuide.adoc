...
You can search for flashcards inside the current folder using keywords in flashcard questions.
...
* `ans 4` +
in response to the card displayed above, where choosing option 4 will give the right answer.
