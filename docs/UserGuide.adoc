...
== Features
// tag::FeaturesHeader[]
This section describes all the commands available in FomoFoto. It provides a short description of what the each does, its format as well as examples on how to use them. The commands are listed in alphabetical order.
