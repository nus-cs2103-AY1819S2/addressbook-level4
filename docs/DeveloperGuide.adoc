...
* Then it uses export utilities to create the file and write the Person's information to it

* If the index specified in invalid, an error message will be displayed

==== Future Implementation
* For future implementation, the `memberExport` command will export the members details in a formatted html page
// end::memberexport[]
...
activities that the club has. `activityAdd` , `activityList` , `activityFind` and
