...
. Configure the <<Docs-SiteWideDocSettings, site-wide documentation settings>> in link:{repoURL}/blob/master/build
.gradle[[.java]#build.gradle#], such as the [.java]#site-name#, to suit your own project.

. Replace the URL in the attribute [.java]#repoURL# in link:{repoURL}/blob/master/docs/DeveloperGuide.adoc[[
.java]#DeveloperGuide.adoc#] and link:{repoURL}/blob/master/docs/UserGuide.adoc[[.java]#UserGuide.adoc#] with the URL
 of your fork.
...
The files in link:{repoURL}/blob/master/docs/stylesheets[[.java]#docs/stylesheets#] are the https://developer.mozilla
...
.  Update the version number in link:{repoURL}/blob/master/src/main/java/seedu/address/MainApp.java[[.java]#MainApp
.java#].
