...
and added to an list of [.java]#DailyRevenue#s.
...
The activity diagram illustrates the cause of actions for different argument inputs.

.Revenue Activity Diagram
image::Revenue_ActivityDiagram.png[]

The above activity diagram summarizes the overall implementation of [.java]#RevenueCommand#. Depending on the user
...
|=======================================================================
| Aspect | Alternative 1 | Alternative 2
| Validation regex of Year, Month and Day
