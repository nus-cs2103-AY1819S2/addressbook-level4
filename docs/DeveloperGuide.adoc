...
Step 1. The user executes the `addToMenu` command by typing the name, code and price of the menu item (e.g.: :computer: `addToMenu n/French Fries c/W12 p/2.50`).
