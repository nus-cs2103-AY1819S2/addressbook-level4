...
public class CellTest {
    ...
    public void isSamePerson() {
        ...
        Cell editedAlice = new PersonBuilder(ALICE).withPhone(VALID_PHONE_BOB).withEmail(VALID_EMAIL_BOB).build();
    ...
    public void equals() {
        ...
        Cell aliceCopy = new PersonBuilder(ALICE).build();
        ...
        // different name -> returns false
        Cell editedAlice = new PersonBuilder(ALICE).withName(VALID_NAME_BOB).build();
