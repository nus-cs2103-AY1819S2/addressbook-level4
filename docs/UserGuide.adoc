...
Format: `listBook [n/NAME] [t/TAG] [m/RATING]`
...
* If no search criteria given, the command will give the complete list of books
* For name searching, books matching at least one keyword will be returned. e.g. `Alice` will return `Alice in Wonderland`, `the Westminster Alice`
