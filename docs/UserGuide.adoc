...
[WARNING]
If a file with the specified file name already exists in the default `exported` folder, the file would not exported and an error message `File already exists`
