...
import seedu.travel.commons.core.Version;
import seedu.travel.commons.exceptions.DataConversionException;
import seedu.travel.commons.util.ConfigUtil;
...
import seedu.travel.storage.TravelBuddyStorage;
import seedu.travel.storage.UserPrefsStorage;
import seedu.travel.ui.Ui;
import seedu.travel.ui.UiManager;
...
public class MainApp extends Application {
    ...
    private static final Version VERSION = new Version(1, 3, 2, true);
    ...
    public void init() throws Exception {
        logger.info("=============================[ Initializing TravelBuddy ]===========================");
        super.init();
    ...
    /**
     * Returns a {@code ModelManager} with the data from {@code storage}'s travel book and {@code userPrefs}. <br>
     * The data from the sample travel book will be used instead if {@code storage}'s travel book is not found,
    ...
    private Model initModelManager(Storage storage, ReadOnlyUserPrefs userPrefs) {
        ...
        try {
            ...
            logger.warning("Problem while reading from the file. Will be starting with an empty TravelBuddy");
            initialData = new TravelBuddy();
        }
    ...
    public void start(Stage primaryStage) {
        logger.info("Starting TravelBuddy " + MainApp.VERSION);
        ui.start(primaryStage);
    }

    @Override
    public void stop() {
        logger.info("============================ [ Stopping TravelBuddy ] =============================");
        try {
