...
public class DeleteCommandSystemTest extends CardFolderSystemTest {
    ...
    public void delete() {
        ...
        /* Case: filtered person list, delete index within bounds of card folder and person list -> deleted */
        showPersonsWithName(KEYWORD_MATCHING_MEIER);
        Index index = INDEX_FIRST_PERSON;
        assertTrue(index.getZeroBased() < getModel().getFilteredPersonList().size());
        assertCommandSuccess(index);

        /* Case: filtered person list, delete index within bounds of card folder but out of bounds of person list
         * -> rejected
         */
        showPersonsWithName(KEYWORD_MATCHING_MEIER);
        int invalidIndex = getModel().getCardFolder().getPersonList().size();
        ...
        Index outOfBoundsIndex = Index.fromOneBased(
                getModel().getCardFolder().getPersonList().size() + 1);
    ...
    /**
     * Removes the {@code Person} at the specified {@code index} in {@code model}'s card folder.
