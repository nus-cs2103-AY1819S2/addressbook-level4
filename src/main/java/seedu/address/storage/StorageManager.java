...
public class StorageManager implements Storage {
    ...
    @Override
    public Optional<ReadOnlyPdfBook> readAddressBook() throws DataConversionException, IOException {
        return readAddressBook(addressBookStorage.getAddressBookFilePath());
    }

    @Override
    public Optional<ReadOnlyPdfBook> readAddressBook(Path filePath) throws DataConversionException, IOException {
