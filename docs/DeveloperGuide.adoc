...
2.  In-Credit-Ble shows a list of persons
3.  User requests to add a specific entry in the list
4.  In-Credit-Ble adds the entry
+
Use case ends.
...
+
[none]
** 3a1. In-Credit-Ble shows an error message.
+
...
2.  In-Credit-Ble shows a list of entries
3.  User requests to delete a specific entry in the list
4.  In-Credit-Ble deletes the entry
+
Use case ends.
...
2.  In-Credit-Ble displays current budget amount for the month
+
Use case ends.
...
[none]
* 2a. As the user spends more, In-Credit-Ble updates the remaining amount in the current month's budget
+
Use case ends.
