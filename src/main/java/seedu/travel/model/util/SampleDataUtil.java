...
public class SampleDataUtil {
    public static Place[] getSamplePlaces() {
        return new Place[] {
            new Place(new Name("VivoCity"), new CountryCode("SGP"), new DateVisited("10/10/2017"),
                    new Rating("1"), new Description("Expansive, modern shopping center "
            ...
            new Place(new Name("Changi Airport Singapore"), new CountryCode("SGP"),
                    new DateVisited("01/01/2019"), new Rating("5"),
            ...
            new Place(new Name("Japanese Cemetery Park"), new CountryCode("SGP"),
                    new DateVisited("11/09/2017"), new Rating("3"),
            ...
            new Place(new Name("Universal Studios Singapore"), new CountryCode("SGP"),
                    new DateVisited("23/12/2017"), new Rating("4"),
            ...
            new Place(new Name("National University of Singapore"), new CountryCode("SGP"),
                    new DateVisited("10/10/2018"), new Rating("4"),
                    ...
                    getTagSet("school")),
            new Place(new Name("Singapore Zoo"), new CountryCode("SGP"), new DateVisited("09/08/2018"),
                    new Rating("3"),
