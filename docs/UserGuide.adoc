...
students who have difficulty managing their finances due to their many daily transactions.

Our user-friendly interface will make it easy for you to see how much you can safely spend within your
...
transactions in a pie chart. If you are an individual who prefers to typing using a Command Line Interface(CLI), then
_In-Credit-Ble_ is the application for you!
