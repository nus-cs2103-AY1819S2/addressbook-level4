...
public class TypicalModules {
    ...
    public static final Module CS1010 = new Module(new ModuleCode("CS1010"),
            ...
            new ModuleDescription("This module introduces the fundamental concepts of problem solving by " +
    ...
    public static final Module CS2030 = new Module(new ModuleCode("CS2030"), new ModuleTitle("Programming Methodology II"),
            new ModuleDescription("This module is a follow up to CS1010. It explores two modern programming paradigms, " +
                    ...
                    "design principles and advanced programming constructs available in the two paradigms. " +
                    "Topics include objects and classes, composition, association, inheritance, " +
    ...
    public static final Module CS2040 = new Module(new ModuleCode("CS2040"), new ModuleTitle("Data Structures and Algorithms"),
            new ModuleDescription("This module introduces students to the design and implementation " +
    ...
    public static final Module LSM1301 = new Module(new ModuleCode("LSM1301"), new ModuleTitle("General Biology"),
            new ModuleDescription("This is an introductory module that explores what a living thing is, " +
                    "the basics of life, and the science behind it. The course will introduce the chemistry " +
                    "of life and the unit of life. The question of how traits are inherited will be discussed " +
                    "and the field of biotechnology, including its applications and the ethical issues " +
                    "involved be will introduced. The diversity of life on earth will be explored, " +
                    "with discussions how life on earth possibly came about and how biologists " +
                    "try to classify and make sense of the diversity. " +
                    "The course will also introduce the concept of life functions from cells to tissues " +
