...
public class TypicalIndexes {
    ...
    public static final Index INDEX_FIRST_WORKLIST = Index.fromOneBased(1);
    public static final Index INDEX_SECOND_WORKLIST = Index.fromOneBased(2);
    public static final Index INDEX_THIRD_WORKLIST = Index.fromOneBased(3);
}
