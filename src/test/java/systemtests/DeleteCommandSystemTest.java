...
public class DeleteCommandSystemTest extends AddressBookSystemTest {
    ...
    public void delete() {
        ...
        /* --------------------- Performing delete operation while a person deck is selected ------------------------ */
     ...
     * and selected deck are expected to update accordingly depending on the deck at {@code expectedSelectedCardIndex}.
     * @see DeleteCommandSystemTest#assertCommandSuccess(String, Model, String)
