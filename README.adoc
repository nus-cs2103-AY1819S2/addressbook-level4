...
Are you a *Real Estate Agent* with a huge amount of different kinds of clients that you have to manage? Are you in need of a new desktop-based app with client management functions just to simplify your life a bit? Are you fairly comfortable with interacting with a CLI (Command Line Interface)?
