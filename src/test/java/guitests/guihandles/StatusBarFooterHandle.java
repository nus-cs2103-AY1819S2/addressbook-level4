...
public class StatusBarFooterHandle extends NodeHandle<Node> {
    ...
    /**
     * Returns true if the current content of the sync status is different from the fullAnswer remembered by the most
     * recent {@code rememberSyncStatus()} call.
     */
    ...
    /**
     * Returns true if the current content of the 'save location' is different from the fullAnswer remembered by the
     * most recent {@code rememberSaveLocation()} call.
     */
