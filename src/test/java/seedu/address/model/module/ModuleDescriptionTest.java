...
public class ModuleDescriptionTest {
    ...
    public void isValidModuleDescription() {
        ...
        assertTrue(ModuleDescription.isValidModuleDescription("The objective of this module is to provide the essentials of ring theory and module theory. " +
                ...
                "principal ideal domains, Euclidean domains, factorization in polynomial domains, modules, " +
                "module isomorphism theorems, cyclic modules, free modules of finite rank, " +
                "finitely generated modules, finitely generated modules over a principal ideal domain.")); //long description
