...
* `ITEM_NAME` has to be in the form of alphanumeric characters and spaces, and should not be blank.
...
a| a| For example, the menu initially has 5 items as shown below.

image::AddToMenu_Before.png[]

Suppose you would like to add a Lobster Burger to the menu. After executing `addToMenu c/W06 n/Lobster Burger p/10.00`, you will see a success message in the Results Display, as shown below.

image::AddToMenu_RD.png[]
The Menu Panel will also be updated and you will now see 6 items displayed. As seen in the image below, a new 6th item with code W06, name Lobster Burger and price of 10.00 has been added to the menu.
