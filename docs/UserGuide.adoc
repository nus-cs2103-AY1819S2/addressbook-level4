...
The export command creates a csv file containing the flashcards from the specified folder in your <<projrootdirectory, project root directory>>.
...
* [[projrootdirectory]]**project root directory**: The directory where Know-It-All's .jar file is located
