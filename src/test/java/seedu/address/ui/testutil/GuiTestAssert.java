...
public class GuiTestAssert {
    ...
    /**
     * Returns the color style for {@code categoryName}'s label. The category's color is determined by looking up the color
     * in {@code RecordCard#CATEGORY_COLOR_STYLES}, using an index generated by the hash code of the category's content.
     *
     *
     */
    ...
    /**
     * Asserts that the categories in {@code actualCard} matches all the categories in {@code expectedRecord} with the correct
     * color.
     */
