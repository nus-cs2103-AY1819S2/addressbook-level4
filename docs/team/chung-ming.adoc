...
This document serves to highlight my contributions to *TravelBuddy*, a travel log application that allows users to efficiently manage their travel records, i.e. the places that they have visited. Additional features built into TravelBuddy allows them to search through the records, attach photos and view statistical models. This  link:https://cs2103-ay1819s2-w11-3.github.io/main/AboutUs.html[team-based] project is part of the CS2103T Software Engineering module in National University of Singapore, in which my team and I were tasked to morph a given link:https://se-education.org/addressbook-level4/[address book] product into a new product -- TravelBuddy. The complete source code for TravelBuddy is available on link:{repoURL}[GitHub].
...
****
_Given below is the start of extract of sections I contributed to the link:https://cs2103-ay1819s2-w11-3.github.io/main/UserGuide.html[User Guide]. They showcase my ability to write documentation targeting end-users._
****
...
****
_Given below is the start of extract of sections I contributed to the link:https://cs2103-ay1819s2-w11-3.github.io/main/UserGuide.html[Developer Guide]. They showcase my ability to write documentation targeting end-users._
****
