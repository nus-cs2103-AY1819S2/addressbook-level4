...
public class StringUtilTest {
    ...
    private void assertExceptionThrown(Class<? extends Throwable> exceptionClass, String sentence, String word,
        ...
        StringUtil.containsPartialWordIgnoreCase(sentence, word);
    }
    ...
    public void containsWordIgnoreCase_validInputs_correctResult() {
        ...
        assertTrue(
            StringUtil.containsPartialWordIgnoreCase("aaa bBb ccc", "Bbb")); // First word (boundary case)
        assertTrue(
            StringUtil.containsPartialWordIgnoreCase("aaa bBb ccc@1", "CCc@1")); // Last word (boundary case)
        assertTrue(
            StringUtil.containsPartialWordIgnoreCase("  AAA   bBb   ccc  ", "aaa")); // Sentence has extra spaces
        assertTrue(
            StringUtil.containsPartialWordIgnoreCase("Aaa", "aaa")); // Only one word in sentence (boundary case)
        assertTrue(
            StringUtil.containsPartialWordIgnoreCase("aaa bbb ccc", "  ccc  ")); // Leading/trailing spaces
