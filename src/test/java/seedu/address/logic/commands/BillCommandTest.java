...
import systemtests.EditCommandSystemTest;
import systemtests.RestOrRantSystemTest;
...
public class BillCommandTest {
    ...
    public void edit() {
        ...
        String command = " " + BillCommand.COMMAND_WORD + "  " + index.getOneBased() + "  " + NAME_DESC_BOB + "  "
