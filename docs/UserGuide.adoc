...
****
* This command can be used in both All Jobs Screen and Job Detail Screen.
* You will be back to All Jobs Screen when you use this command in Job Detail Screen and all applicants will show in `All Applicants` List.
****
...
=== Schedule Interviews and Generate Final Report Related Features
