...
. <<MenuMode, *`menuMode`*>>: Switch over to Menu Mode to fill up the menu in RestOrRant with your restaurant's menu information.
...
[NOTE]
RestOrRant will check for other reservations and availabilities of tables before allowing the user to make a reservation.
